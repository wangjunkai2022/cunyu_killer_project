...
public class DiffUtil {
    ...
    private static Snake forward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            ...
            int i8 = (range.newListStart + (i3 - range.oldListStart)) - i6;
            int i9 = (i == 0 || i3 != i2) ? i8 : i8 - 1;
            while (i3 < range.oldListEnd && i8 < range.newListEnd) {
                if (!callback.areItemsTheSame(i3, i8)) {
                    break;
                }
                i3++;
                i8++;
    ...
    private static Snake backward(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2, int i) {
        ...
        for (int i6 = i5; i6 <= i; i6 += 2) {
            ...
            int i8 = range.newListEnd - ((range.oldListEnd - i3) - i6);
            int i9 = (i == 0 || i3 != i2) ? i8 : i8 + 1;
            while (i3 > range.oldListStart && i8 > range.newListStart) {
                if (!callback.areItemsTheSame(i3 - 1, i8 - 1)) {
                    break;
                }
                i3--;
                i8--;
