...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent, int i3) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        dispatchNestedScroll(i5, i7, i4, i6, this.mScrollOffset, i3, iArr3);
        ...
        if (!(i5 == 0 && i7 == 0)) {
            dispatchOnScrolled(i5, i7);
        }
        if (!awakenScrollBars()) {
            invalidate();
        }
        return (!z && i5 == 0 && i7 == 0) ? false : true;
    }
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:103:0x022b A[ADDED_TO_REGION] */
