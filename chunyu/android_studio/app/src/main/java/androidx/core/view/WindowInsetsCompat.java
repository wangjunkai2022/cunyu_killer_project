...
public class WindowInsetsCompat {
    ...
    public int getSystemWindowInsetTop() {
        return this.mImpl.getSystemWindowInsets().f8top;
    }
    ...
    public int getStableInsetTop() {
        return this.mImpl.getStableInsets().f8top;
    }
    ...
    public WindowInsetsCompat inset(Insets insets) {
        return inset(insets.left, insets.f8top, insets.right, insets.bottom);
    }
    ...
    public static class Impl20 extends Impl {
        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i != 1) {
                ...
                return Insets.of(0, Math.max(getRootStableInsets().f8top, getSystemWindowInsets().f8top), 0, 0);
            } else {
                return Insets.of(0, getSystemWindowInsets().f8top, 0, 0);
            }
        }
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f8top - i2);
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        void setSystemWindowInsets(Insets insets) {
            ...
            if (windowInsets != null) {
                this.mPlatformInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f8top, insets.right, insets.bottom);
            }
        }
