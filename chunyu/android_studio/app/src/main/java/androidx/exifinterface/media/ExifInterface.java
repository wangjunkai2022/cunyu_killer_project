...
public class ExifInterface {
    ...
    private static final ExifTag[] IFD_THUMBNAIL_TAGS = {new ExifTag(TAG_NEW_SUBFILE_TYPE, 254, 4), new ExifTag(TAG_SUBFILE_TYPE, 255, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_WIDTH, 256, 3, 4), new ExifTag(TAG_THUMBNAIL_IMAGE_LENGTH, 257, 3, 4), new ExifTag(TAG_BITS_PER_SAMPLE, 258, 3), new ExifTag(TAG_COMPRESSION, 259, 3), new ExifTag(TAG_PHOTOMETRIC_INTERPRETATION, 262, 3), new ExifTag(TAG_IMAGE_DESCRIPTION, 270, 2), new ExifTag(TAG_MAKE, 271, 2), new ExifTag(TAG_MODEL, 272, 2), new ExifTag(TAG_STRIP_OFFSETS, b.a, 3, 4), new ExifTag(TAG_THUMBNAIL_ORIENTATION, TiffUtil.TIFF_TAG_ORIENTATION, 3), new ExifTag(TAG_SAMPLES_PER_PIXEL, 277, 3), new ExifTag(TAG_ROWS_PER_STRIP, 278, 3, 4), new ExifTag(TAG_STRIP_BYTE_COUNTS, 279, 3, 4), new ExifTag(TAG_X_RESOLUTION, 282, 5), new ExifTag(TAG_Y_RESOLUTION, 283, 5), new ExifTag(TAG_PLANAR_CONFIGURATION, 284, 3), new ExifTag(TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(TAG_TRANSFER_FUNCTION, 301, 3), new ExifTag(TAG_SOFTWARE, 305, 2), new ExifTag(TAG_DATETIME, 306, 2), new ExifTag(TAG_ARTIST, 315, 2), new ExifTag(TAG_WHITE_POINT, 318, 5), new ExifTag(TAG_PRIMARY_CHROMATICITIES, 319, 5), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT, 513, 4), new ExifTag(TAG_JPEG_INTERCHANGE_FORMAT_LENGTH, 514, 4), new ExifTag(TAG_Y_CB_CR_COEFFICIENTS, 529, 5), new ExifTag(TAG_Y_CB_CR_SUB_SAMPLING, 530, 3), new ExifTag(TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_REFERENCE_BLACK_WHITE, 532, 5), new ExifTag(TAG_COPYRIGHT, 33432, 2), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4), new ExifTag(TAG_DNG_VERSION, 50706, 1), new ExifTag(TAG_DEFAULT_CROP_SIZE, 50720, 3, 4)};
    ...
    private static SimpleDateFormat sFormatterSecondary = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.US);
                    ...
                    switch (this.format) {
                        ...
                        case 3:
                            ...
                            while (i < this.numberOfComponents) {
                                iArr[i] = byteOrderedDataInputStream2.readUnsignedShort();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 4:
                            ...
                            while (i < this.numberOfComponents) {
                                jArr[i] = byteOrderedDataInputStream2.readUnsignedInt();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 5:
                            ...
                            while (i < this.numberOfComponents) {
                                rationalArr[i] = new Rational(byteOrderedDataInputStream2.readUnsignedInt(), byteOrderedDataInputStream2.readUnsignedInt());
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 8:
                            ...
                            while (i < this.numberOfComponents) {
                                iArr2[i] = byteOrderedDataInputStream2.readShort();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 9:
                            ...
                            while (i < this.numberOfComponents) {
                                iArr3[i] = byteOrderedDataInputStream2.readInt();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 10:
                            ...
                            while (i < this.numberOfComponents) {
                                rationalArr2[i] = new Rational((long) byteOrderedDataInputStream2.readInt(), (long) byteOrderedDataInputStream2.readInt());
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 11:
                            ...
                            while (i < this.numberOfComponents) {
                                dArr[i] = (double) byteOrderedDataInputStream2.readFloat();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
                        ...
                        case 12:
                            ...
                            while (i < this.numberOfComponents) {
                                dArr2[i] = byteOrderedDataInputStream2.readDouble();
                                i++;
                            }
                            try {
                                byteOrderedDataInputStream2.close();
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: SSATransform
        jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 10, insn: 0x0138: MOVE  (r1 I:??[OBJECT, ARRAY]) = (r10 I:??[OBJECT, ARRAY]), block:B:80:0x0138
    ...
    /* JADX WARN: Removed duplicated region for block: B:37:0x0066 A[Catch: Exception -> 0x009f, all -> 0x00bd, TRY_ENTER, TRY_LEAVE, TryCatch #0 {Exception -> 0x009f, blocks: (B:37:0x0066, B:40:0x007c, B:42:0x0088, B:47:0x0093, B:48:0x0098, B:49:0x0099, B:50:0x009e, B:53:0x00a1, B:54:0x00a6), top: B:69:0x0064 }] */
    /* JADX WARN: Removed duplicated region for block: B:53:0x00a1 A[Catch: Exception -> 0x009f, all -> 0x00bd, TryCatch #0 {Exception -> 0x009f, blocks: (B:37:0x0066, B:40:0x007c, B:42:0x0088, B:47:0x0093, B:48:0x0098, B:49:0x0099, B:50:0x009e, B:53:0x00a1, B:54:0x00a6), top: B:69:0x0064 }] */
    /* JADX WARN: Removed duplicated region for block: B:62:0x00b9  */
    /* JADX WARN: Removed duplicated region for block: B:67:0x00c3  */
    /* JADX WARN: Type inference failed for: r1v1, types: [byte[]] */
    /* JADX WARN: Type inference failed for: r1v14 */
    /* JADX WARN: Type inference failed for: r1v18, types: [android.content.res.AssetManager$AssetInputStream, java.io.Closeable, java.io.InputStream] */
    ...
    /* JADX WARN: Removed duplicated region for block: B:33:0x00c0 A[FALL_THROUGH] */
    /* Code decompiled incorrectly, please refer to instructions dump */
        ...
        if (exifAttribute != null && exifAttribute2 != null) {
            ...
            if (convertToLongArray == null || convertToLongArray.length == 0) {
                ...
                for (int i3 = 0; i3 < convertToLongArray.length; i3++) {
                    ...
                    if (i3 < convertToLongArray.length - 1 && ((long) (i4 + i5)) != convertToLongArray[i3 + 1]) {
                    ...
                    if (byteOrderedDataInputStream.skip(j3) != j3) {
                        Log.d(TAG, "Failed to skip " + i6 + " bytes.");
                        return;
                    }
                    int i7 = i + i6;
                    byte[] bArr2 = new byte[i5];
                    if (byteOrderedDataInputStream.read(bArr2) != i5) {
                        Log.d(TAG, "Failed to read " + i5 + " bytes.");
                        return;
                    }
                    i = i7 + i5;
    ...
    private int writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) throws IOException {
        ...
        if (DEBUG) {
            for (int i7 = 0; i7 < EXIF_TAGS.length; i7++) {
                Log.d(TAG, String.format("index: %d, offsets: %d, tag count: %d, data sizes: %d, total size: %d", Integer.valueOf(i7), Integer.valueOf(iArr[i7]), Integer.valueOf(this.mAttributes[i7].size()), Integer.valueOf(iArr2[i7]), Integer.valueOf(i5)));
            }
        }
        if (!this.mAttributes[1].isEmpty()) {
