...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<FlowCollector<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x0085 A[Catch: all -> 0x00ad, TRY_LEAVE, TryCatch #1 {all -> 0x00ad, blocks: (B:21:0x007d, B:23:0x0085), top: B:37:0x007d }] */
    ...
    public static final void m8invokeSuspend$lambda0(Channel channel, WindowLayoutInfo windowLayoutInfo) {
        Intrinsics.checkNotNullExpressionValue(windowLayoutInfo, "info");
        channel.mo1464trySendJP2dKIU(windowLayoutInfo);
    }
}
