    ...
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null) {
            if (!(charSequence.length() == 0)) {
                ...
                if (Intrinsics.areEqual(obj, ProxyConfig.MATCH_ALL_SCHEMES) || StringsKt.indexOf$default((CharSequence) obj, (char) FilenameUtils.EXTENSION_SEPARATOR, 0, false, 6, (Object) null) >= 0) {
