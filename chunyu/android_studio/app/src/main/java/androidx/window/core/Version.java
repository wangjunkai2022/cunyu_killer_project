...
public final class Version implements Comparable<Version> {
    ...
    private Version(int i, int i2, int i3, String str) {
        ...
        this.bigInteger$delegate = LazyKt.lazy(new Function0<BigInteger>() { // from class: androidx.window.core.Version$bigInteger$2
            ...
            public final BigInteger invoke() {
                return BigInteger.valueOf((long) Version.this.getMajor()).shiftLeft(32).or(BigInteger.valueOf((long) Version.this.getMinor())).shiftLeft(32).or(BigInteger.valueOf((long) Version.this.getPatch()));
            }
        });
    }
    ...
    public String toString() {
        ...
        return this.major + FilenameUtils.EXTENSION_SEPARATOR + this.minor + FilenameUtils.EXTENSION_SEPARATOR + this.patch + stringPlus;
    }
