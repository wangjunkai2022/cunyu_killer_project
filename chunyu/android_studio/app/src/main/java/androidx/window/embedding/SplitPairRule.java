...
public final class SplitPairRule extends SplitRule {
    ...
    @Override // androidx.window.embedding.SplitRule
    public int hashCode() {
        return (((((((super.hashCode() * 31) + this.filters.hashCode()) * 31) + Boolean.valueOf(this.finishPrimaryWithSecondary).hashCode()) * 31) + Boolean.valueOf(this.finishSecondaryWithPrimary).hashCode()) * 31) + Boolean.valueOf(this.clearTop).hashCode();
    }
}
