...
public class WidgetGroup {
    ...
    public class MeasureResult {
        ...
        public MeasureResult(ConstraintWidget constraintWidget, LinearSystem linearSystem, int i) {
            ...
            this.f5top = linearSystem.getObjectVariableValue(constraintWidget.mTop);
        ...
        public void apply() {
            ...
            if (constraintWidget != null) {
                constraintWidget.setFinalFrame(this.left, this.f5top, this.right, this.bottom, this.baseline, this.orientation);
            }
        }
    }
}
