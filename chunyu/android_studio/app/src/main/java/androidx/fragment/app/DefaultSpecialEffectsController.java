...
class DefaultSpecialEffectsController extends SpecialEffectsController {
            ...
            if (!transitionInfo3.hasSharedElementTransition() || operation6 == null || operation7 == null) {
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    if (!arrayList4.isEmpty()) {
                        view5 = (View) arrayMap3.get(arrayList4.get(0));
                        fragmentTransitionImpl2.setEpicenter(wrapTransitionInSet, view5);
                    } else {
                        view5 = view5;
                    }
                    for (View view9 : arrayMap4.values()) {
                        captureTransitioningViews(arrayList7, view9);
                    }
                    if (!sharedElementTargetNames2.isEmpty()) {
                        z3 = false;
                        final View view10 = (View) arrayMap4.get(sharedElementTargetNames2.get(0));
                        if (view10 != null) {
                            rect2 = rect3;
                            OneShotPreDrawListener.add(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.7
                                @Override // java.lang.Runnable
                                public void run() {
                                    fragmentTransitionImpl2.getBoundsOnScreen(view10, rect2);
                                }
                            });
                            view3 = view4;
                            z6 = true;
    ...
    public static class AnimationInfo extends SpecialEffectsInfo {
        ...
        FragmentAnim.AnimationOrAnimator getAnimation(Context context) {
            ...
            this.mAnimation = FragmentAnim.loadAnimation(context, getOperation().getFragment(), getOperation().getFinalState() == SpecialEffectsController.Operation.State.VISIBLE);
