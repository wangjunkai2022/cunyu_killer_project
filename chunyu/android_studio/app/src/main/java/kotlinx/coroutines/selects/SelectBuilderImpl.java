...
public final class SelectBuilderImpl<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable th) {
        if (trySelect()) {
            ...
            resumeWith(Result.m43constructorimpl(ResultKt.createFailure(th)));
    ...
    public void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        if (j > 0) {
            disposeOnSelect(DelayKt.getDelay(getContext()).invokeOnTimeout(j, new Runnable(function1) { // from class: kotlinx.coroutines.selects.SelectBuilderImpl$onTimeout$$inlined$Runnable$1
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj2 == SelectKt.UNDECIDED) {
                    if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, CompletionStateKt.toState$default(obj, null, 1, null))) {
                        return;
                    }
                    ...
                    if (Result.m49isFailureimpl(obj)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable r4 = Result.m46exceptionOrNullimpl(obj);
                        Intrinsics.checkNotNull(r4);
                        Result.Companion companion = Result.Companion;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            r4 = StackTraceRecoveryKt.recoverFromStackFrame(r4, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(r4)));
                        return;
                    }
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || isSelected()) {
            while (true) {
                ...
                if (obj == SelectKt.UNDECIDED) {
                    ...
                    if (_result$FU.compareAndSet(this, SelectKt.UNDECIDED, new CompletedExceptionally(th2, false, 2, null))) {
                        return;
                    }
                } else if (obj != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    throw new IllegalStateException("Already resumed");
                    ...
                    Result.Companion companion = Result.Companion;
                    intercepted.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(th)));
                    return;
                }
            }
        } else {
