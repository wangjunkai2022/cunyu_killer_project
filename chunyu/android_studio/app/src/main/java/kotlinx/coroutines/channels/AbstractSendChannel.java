...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final Object mo1464trySendJP2dKIU(E e) {
        ...
        if (offerInternal == AbstractChannelKt.OFFER_FAILED) {
            ...
            return ChannelResult.Companion.m1482closedJP2dKIU(helpCloseAndGetSendException(closedForSend));
        } else if (offerInternal instanceof Closed) {
            return ChannelResult.Companion.m1482closedJP2dKIU(helpCloseAndGetSendException((Closed) offerInternal));
        } else {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        if (function1 == null || (callUndeliveredElementCatchingException$default = OnUndeliveredElementKt.callUndeliveredElementCatchingException$default(function1, e, null, 2, null)) == null) {
            ...
            continuation.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(sendException)));
            return;
        }
        ...
        continuation.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(undeliveredElementException)));
    }
    ...
    protected Object enqueueSend(Send send) {
        ...
        Send send2 = send;
        AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 abstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 = new LockFreeLinkedListNode.CondAddOp(this) { // from class: kotlinx.coroutines.channels.AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1514constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1519plusFjFbRPM(r2, receive);
            }
        }
        if (r2 != null) {
