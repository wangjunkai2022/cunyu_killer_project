        ...
        while (true) {
            ...
            if (obj != null && obj != StateFlowKt.PENDING) {
                if (obj == StateFlowKt.NONE) {
                    ...
                    ((CancellableContinuationImpl) obj).resumeWith(Result.m43constructorimpl(Unit.INSTANCE));
                    return;
                }
            } else {
                return;
    ...
    public final Object awaitPending(Continuation<? super Unit> continuation) {
        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || (!(this._state instanceof CancellableContinuationImpl))) {
            if (!_state$FU.compareAndSet(this, StateFlowKt.NONE, cancellableContinuationImpl2)) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl2.resumeWith(Result.m43constructorimpl(Unit.INSTANCE));
            }
