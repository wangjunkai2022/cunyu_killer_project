...
public final class TimeoutKt {
    ...
    public static final <T> Object m1457withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1455toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> java.lang.Object withTimeoutOrNull(long r7, kotlin.jvm.functions.Function2<? super kotlinx.coroutines.CoroutineScope, ? super kotlin.coroutines.Continuation<? super T>, ? extends java.lang.Object> r9, kotlin.coroutines.Continuation<? super T> r10) {
        ...
        L_0x004b:
            ...
            r10.<init>()
            r0.L$0 = r9     // Catch: TimeoutCancellationException -> 0x0075
            r0.L$1 = r10     // Catch: TimeoutCancellationException -> 0x0075
            r0.J$0 = r7     // Catch: TimeoutCancellationException -> 0x0075
            r0.label = r4     // Catch: TimeoutCancellationException -> 0x0075
            r2 = r0
            kotlin.coroutines.Continuation r2 = (kotlin.coroutines.Continuation) r2     // Catch: TimeoutCancellationException -> 0x0075
            kotlinx.coroutines.TimeoutCoroutine r4 = new kotlinx.coroutines.TimeoutCoroutine     // Catch: TimeoutCancellationException -> 0x0075
            r4.<init>(r7, r2)     // Catch: TimeoutCancellationException -> 0x0075
            r10.element = r4     // Catch: TimeoutCancellationException -> 0x0075
            java.lang.Object r7 = setupTimeout(r4, r9)     // Catch: TimeoutCancellationException -> 0x0075
            java.lang.Object r8 = kotlin.coroutines.intrinsics.IntrinsicsKt.getCOROUTINE_SUSPENDED()     // Catch: TimeoutCancellationException -> 0x0075
            if (r7 != r8) goto L_0x0071
            kotlin.coroutines.Continuation r0 = (kotlin.coroutines.Continuation) r0     // Catch: TimeoutCancellationException -> 0x0075
            kotlin.coroutines.jvm.internal.DebugProbesKt.probeCoroutineSuspended(r0)     // Catch: TimeoutCancellationException -> 0x0075
        L_0x0071:
    ...
    public static final <T> Object m1458withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1455toDelayMillisLRDsOJo(j), function2, continuation);
    }
