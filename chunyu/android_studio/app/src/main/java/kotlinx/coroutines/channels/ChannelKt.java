...
public final class ChannelKt {
    ...
    public static final <T> T m1465getOrElseWpGqRn0(Object obj, Function1<? super Throwable, ? extends T> function1) {
        return obj instanceof ChannelResult.Failed ? (T) function1.invoke(ChannelResult.m1473exceptionOrNullimpl(obj)) : obj;
    }

    /* renamed from: onSuccess-WpGqRn0 */
    public static final <T> Object m1468onSuccessWpGqRn0(Object obj, Function1<? super T, Unit> function1) {
    ...
    public static final <T> Object m1467onFailureWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
        if (obj instanceof ChannelResult.Failed) {
            function1.invoke(ChannelResult.m1473exceptionOrNullimpl(obj));
        }
        return obj;
    }

    /* renamed from: onClosed-WpGqRn0 */
    public static final <T> Object m1466onClosedWpGqRn0(Object obj, Function1<? super Throwable, Unit> function1) {
