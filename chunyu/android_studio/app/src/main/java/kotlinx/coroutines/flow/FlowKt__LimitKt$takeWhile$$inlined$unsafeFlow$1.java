...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L_0x0039:
            ...
            r2.<init>(r4, r6)
            r6 = r2
            kotlinx.coroutines.flow.FlowCollector r6 = (kotlinx.coroutines.flow.FlowCollector) r6     // Catch: AbortFlowException -> 0x0056
            r0.L$0 = r2     // Catch: AbortFlowException -> 0x0056
            r0.label = r3     // Catch: AbortFlowException -> 0x0056
            java.lang.Object r6 = r7.collect(r6, r0)     // Catch: AbortFlowException -> 0x0056
        ...
        L_0x0057:
            ...
            kotlinx.coroutines.flow.internal.FlowExceptions_commonKt.checkOwnership(r7, r2)
        L_0x005c:
