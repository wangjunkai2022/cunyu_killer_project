...
public final class ValueOrClosed<T> {
    ...
    public static final /* synthetic */ ValueOrClosed m1486boximpl(Object obj) {
        return new ValueOrClosed(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static Object m1487constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1488equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ValueOrClosed) && Intrinsics.areEqual(obj, ((ValueOrClosed) obj2).m1496unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1489equalsimpl0(Object obj, Object obj2) {
    ...
    public static int m1493hashCodeimpl(Object obj) {
        if (obj != null) {
            return obj.hashCode();
        }
        return 0;
    ...
    public boolean equals(Object obj) {
        return m1488equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1493hashCodeimpl(this.holder);
    }

    public String toString() {
        return m1495toStringimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m1496unboximpl() {
        return this.holder;
    }
    ...
    public static final boolean m1494isClosedimpl(Object obj) {
        return obj instanceof Closed;
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: getValue-impl  reason: not valid java name */
    public static final T m1491getValueimpl(Object obj) {
    ...
    public static final T m1492getValueOrNullimpl(Object obj) {
        if (obj instanceof Closed) {
            return null;
        }
        return obj;
    ...
    public static final Throwable m1490getCloseCauseimpl(Object obj) {
        if (obj instanceof Closed) {
    ...
    public static String m1495toStringimpl(Object obj) {
        if (obj instanceof Closed) {
            return obj.toString();
        }
        return "Value(" + obj + ')';
    ...
    public static final class Companion {
        ...
        public final <E> Object m1498valueZYPwvRU$kotlinx_coroutines_core(E e) {
            return ValueOrClosed.m1487constructorimpl(e);
        }

        /* renamed from: closed-ZYPwvRU$kotlinx_coroutines_core  reason: not valid java name */
        public final <E> Object m1497closedZYPwvRU$kotlinx_coroutines_core(Throwable th) {
            return ValueOrClosed.m1487constructorimpl(new Closed(th));
        }
    }
}
