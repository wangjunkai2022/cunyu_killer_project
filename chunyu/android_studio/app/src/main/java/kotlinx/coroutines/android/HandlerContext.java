...
public final class HandlerContext extends HandlerDispatcher implements Delay {
    ...
    public DisposableHandle invokeOnTimeout(long j, Runnable runnable, CoroutineContext coroutineContext) {
        if (this.handler.postDelayed(runnable, RangesKt.coerceAtMost(j, 4611686018427387903L))) {
            return new DisposableHandle(runnable) { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerContext$AYyJ57IpsQxcbmCNx8xF14_GmdI
                ...
                public final void dispose() {
                    HandlerContext.m1459invokeOnTimeout$lambda3(HandlerContext.this, this.f$1);
                }
            };
        }
        cancelOnRejection(coroutineContext, runnable);
    ...
    public static final void m1459invokeOnTimeout$lambda3(HandlerContext handlerContext, Runnable runnable) {
    ...
    public void scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
        HandlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1 handlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1 = new Runnable(this) { // from class: kotlinx.coroutines.android.HandlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1
            ...
            public final void run() {
                CancellableContinuation.this.resumeUndispatched(this.this$0, Unit.INSTANCE);
            }
        };
        if (this.handler.postDelayed(handlerContext$scheduleResumeAfterDelay$$inlined$Runnable$1, RangesKt.coerceAtMost(j, 4611686018427387903L))) {
