...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1 implements Flow<T> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        ...
        Object collect = flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1.2
            ...
            public final Object emit$$forInline(Object obj, Continuation continuation2) {
                InlineMarker.mark(4);
                new ContinuationImpl(continuation2) { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$.inlined.unsafeTransform.1.2.1
                    Object L$0;
                    Object L$1;
                    int label;
    ...
    public Object collect$$forInline(final FlowCollector flowCollector, Continuation continuation) {
        ...
        final Function2 function2 = this.$predicate$inlined;
        InlineMarker.mark(0);
        flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1.2
            @Override // kotlinx.coroutines.flow.FlowCollector
            /* Code decompiled incorrectly, please refer to instructions dump */
            public final java.lang.Object emit(T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
                /*
