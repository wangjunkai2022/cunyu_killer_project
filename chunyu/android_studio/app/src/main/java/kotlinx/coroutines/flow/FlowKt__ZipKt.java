...
public final /* synthetic */ class FlowKt__ZipKt {
    ...
    public static final <T1, T2, T3, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Function4<? super T1, ? super T2, ? super T3, ? super Continuation<? super R>, ? extends Object> function4) {
        return new Flow<R>(new Flow[]{flow, flow2, flow3}, function4) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$1
            final /* synthetic */ Flow[] $flows$inlined;
            final /* synthetic */ Function4 $transform$inlined$1;

            {
                this.$flows$inlined = r1;
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                ...
                final Function4 function42 = this.$transform$inlined$1;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null), continuation);
            ...
            public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector2, Object[] objArr, Continuation<? super Unit> continuation2) {
                    AnonymousClass2 r0 = new AnonymousClass2(continuation2, function42);
                    r0.L$0 = flowCollector2;
                    r0.L$1 = objArr;
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        Function4 function4 = function42;
    ...
    public static final <T1, T2, T3, T4, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super Continuation<? super R>, ? extends Object> function5) {
        return new Flow<R>(new Flow[]{flow, flow2, flow3, flow4}, function5) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$2
            final /* synthetic */ Flow[] $flows$inlined;
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                Flow[] flowArr = this.$flows$inlined;
                Function0 function0 = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
                final Function5 function52 = this.$transform$inlined$1;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null), continuation);
                if (combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    return combineInternal;
                }
            ...
            public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector2, Object[] objArr, Continuation<? super Unit> continuation2) {
                    AnonymousClass2 r0 = new AnonymousClass2(continuation2, function52);
                    r0.L$0 = flowCollector2;
                    r0.L$1 = objArr;
                    return r0.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        flowCollector = (FlowCollector) this.L$0;
                        Object[] objArr = (Object[]) this.L$1;
                        Function5 function5 = function52;
                        Object obj2 = objArr[0];
                        Object obj3 = objArr[1];
                        Object obj4 = objArr[2];
    ...
    public static final <T1, T2, T3, T4, T5, R> Flow<R> combine(Flow<? extends T1> flow, Flow<? extends T2> flow2, Flow<? extends T3> flow3, Flow<? extends T4> flow4, Flow<? extends T5> flow5, Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super Continuation<? super R>, ? extends Object> function6) {
        return new Flow<R>(new Flow[]{flow, flow2, flow3, flow4, flow5}, function6) { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$combineUnsafe$FlowKt__ZipKt$3
            final /* synthetic */ Flow[] $flows$inlined;
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                Flow[] flowArr = this.$flows$inlined;
                Function0 function0 = FlowKt__ZipKt.nullArrayFactory$FlowKt__ZipKt();
                final Function6 function62 = this.$transform$inlined$1;
                Object combineInternal = CombineKt.combineInternal(flowCollector, flowArr, function0, new AnonymousClass2(null), continuation);
                if (combineInternal == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    return combineInternal;
                }
            ...
            public static final class AnonymousClass2 extends SuspendLambda implements Function3<FlowCollector<? super R>, Object[], Continuation<? super Unit>, Object> {
                ...
                public final Object invoke(FlowCollector<? super R> flowCollector2, Object[] objArr, Continuation<? super Unit> continuation2) {
                    AnonymousClass2 r0 = new AnonymousClass2(continuation2, function62);
                    r0.L$0 = flowCollector2;
                    r0.L$1 = objArr;
                    return r0.invokeSuspend(Unit.INSTANCE);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ...
                        flowCollector = (FlowCollector) this.L$0;
                        Object[] objArr = (Object[]) this.L$1;
                        Function6 function6 = function62;
                        Object obj2 = objArr[0];
                        Object obj3 = objArr[1];
                        Object obj4 = objArr[2];
                        Object obj5 = objArr[3];
