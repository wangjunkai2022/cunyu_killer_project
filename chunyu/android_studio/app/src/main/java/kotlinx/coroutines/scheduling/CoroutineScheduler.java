...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    private final long incrementBlockingTasks() {
        return controlState$FU.addAndGet(this, PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE);
    }
