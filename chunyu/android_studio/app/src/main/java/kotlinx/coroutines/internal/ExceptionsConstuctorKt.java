...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                obj = Result.m43constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return new Function1<Throwable, Throwable>(constructor) { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        Result.Companion companion2 = Result.Companion;
                        obj = Result.m43constructorimpl(ResultKt.createFailure(th2));
                    }
                    if (newInstance != null) {
                        Throwable th3 = (Throwable) newInstance;
                        th3.initCause(th);
                        obj = Result.m43constructorimpl(th3);
                        if (Result.m49isFailureimpl(obj)) {
                            obj = null;
                        }
            ...
            if (Intrinsics.areEqual(cls, Throwable.class)) {
                return new Function1<Throwable, Throwable>(constructor) { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (newInstance != null) {
                            obj = Result.m43constructorimpl((Throwable) newInstance);
                            if (Result.m49isFailureimpl(obj)) {
                                obj = null;
                            }
                            return (Throwable) obj;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$safeCtor$1
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.Companion;
                    obj = Result.m43constructorimpl((Throwable) Function1.this.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.Companion;
                    obj = Result.m43constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            obj = Result.m43constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m43constructorimpl(ResultKt.createFailure(th));
        }
