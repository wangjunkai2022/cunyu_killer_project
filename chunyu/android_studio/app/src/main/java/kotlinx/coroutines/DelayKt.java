...
public final class DelayKt {
    ...
    public static final Object m1454delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1455toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1455toDelayMillisLRDsOJo(long j) {
        if (Duration.m1317compareToLRDsOJo(j, Duration.Companion.m1420getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1336getInWholeMillisecondsimpl(j), 1L);
        }
        return 0;
    }
}
