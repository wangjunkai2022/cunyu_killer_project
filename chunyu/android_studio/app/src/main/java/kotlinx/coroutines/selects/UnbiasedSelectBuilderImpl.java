...
public final class UnbiasedSelectBuilderImpl<R> implements SelectBuilder<R> {
    ...
    public void invoke(SelectClause0 selectClause0, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        this.clauses.add(new Function0<Unit>(this, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$1
            ...
            public final void invoke2() {
                SelectClause0.this.registerSelectClause0(this.this$0.getInstance(), this.$block);
            }
        });
    }
    ...
    public <Q> void invoke(SelectClause1<? extends Q> selectClause1, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        this.clauses.add(new Function0<Unit>(selectClause1, this, function2) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$2
    ...
    public <P, Q> void invoke(SelectClause2<? super P, ? extends Q> selectClause2, P p, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        this.clauses.add(new Function0<Unit>(selectClause2, this, p, function2) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$3
            final /* synthetic */ Function2<Q, Continuation<? super R>, Object> $block;
    ...
    public void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        this.clauses.add(new Function0<Unit>(this, j, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$onTimeout$1
            final /* synthetic */ Function1<Continuation<? super R>, Object> $block;
