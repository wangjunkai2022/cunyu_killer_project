...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public boolean enqueueReceiveInternal(Receive<? super E> receive) {
        ...
        if (isBufferAlwaysEmpty()) {
            ...
            AbstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 abstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1 = new LockFreeLinkedListNode.CondAddOp(this) { // from class: kotlinx.coroutines.channels.AbstractChannel$enqueueReceiveInternal$$inlined$addLastIfPrevAndIf$1
    ...
    public final java.lang.Object mo1462receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r5 = r0.m1482closedJP2dKIU(r5)
            goto L_0x0052
        L_0x004c:
            kotlinx.coroutines.channels.ChannelResult$Companion r0 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r5 = r0.m1484successJP2dKIU(r5)
        L_0x0052:
            return r5
        L_0x0053:
            r0.label = r3
        ...
        L_0x005c:
            ...
            java.lang.Object r5 = r5.m1481unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.mo1462receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    /* renamed from: tryReceive-PtdJZtk */
    public final Object mo1463tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        if (pollInternal == AbstractChannelKt.POLL_FAILED) {
            return ChannelResult.Companion.m1483failurePtdJZtk();
        }
        if (pollInternal instanceof Closed) {
            return ChannelResult.Companion.m1482closedJP2dKIU(((Closed) pollInternal).closeCause);
        }
        return ChannelResult.Companion.m1484successJP2dKIU(pollInternal);
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m1514constructorimpl$default(null, 1, null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    mo1461onCancelIdempotentListww6eGU(r0, closedForSend);
                    return;
                    ...
                    r0 = InlineList.m1519plusFjFbRPM(r0, (Send) prevNode);
                }
            }
        } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            if (i == 0) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1469boximpl(ChannelResult.Companion.m1482closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
            }
        } else if (i == 1) {
            ChannelResult.Companion companion = ChannelResult.Companion;
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1469boximpl(z ? companion.m1482closedJP2dKIU(((Closed) obj).closeCause) : companion.m1484successJP2dKIU(obj)), selectInstance.getCompletion());
        } else {
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m43constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuationImpl.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            return this.receiveMode == 1 ? ChannelResult.m1469boximpl(ChannelResult.Companion.m1484successJP2dKIU(e)) : e;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m43constructorimpl(ChannelResult.m1469boximpl(ChannelResult.Companion.m1482closedJP2dKIU(closed.closeCause))));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E e) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1469boximpl(ChannelResult.Companion.m1484successJP2dKIU(e)) : e, this.select.getCompletion(), resumeOnCancellationFun(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1469boximpl(ChannelResult.Companion.m1482closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    protected void mo1461onCancelIdempotentListww6eGU(Object obj, Closed<?> closed) {
        if (obj != null) {
