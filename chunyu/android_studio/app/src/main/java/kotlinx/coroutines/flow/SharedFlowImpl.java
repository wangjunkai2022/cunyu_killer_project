...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(12:2|(2:4|(10:6|8|(3:(2:54|(1:(8:13|14|15|36|63|(2:37|(1:46)(4:62|(1:40)(1:41)|42|(1:44)(5:45|36|63|37|(0)(0))))|61|48)(2:16|17))(7:18|19|20|63|(2:37|(0)(0))|61|48))(4:23|59|24|25)|52|53)(5:28|57|29|(2:31|(1:33))|34)|55|35|36|63|(2:37|(0)(0))|61|48))|7|8|(0)(0)|55|35|36|63|(2:37|(0)(0))|61|48) */
    ...
    /* JADX WARN: Removed duplicated region for block: B:46:0x00d5 A[Catch: all -> 0x00e6, TRY_LEAVE, TryCatch #1 {all -> 0x00e6, blocks: (B:35:0x00a1, B:37:0x00b2, B:41:0x00bd, B:42:0x00c0, B:46:0x00d5), top: B:55:0x00a1 }] */
    /* JADX WARN: Removed duplicated region for block: B:62:0x00ba A[SYNTHETIC] */
    /* JADX WARN: Type inference failed for: r9v0, types: [kotlinx.coroutines.flow.FlowCollector, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r9v16, types: [kotlinx.coroutines.flow.SharedFlowSlot] */
    ...
    public final Continuation<Unit>[] updateCollectorIndexLocked$kotlinx_coroutines_core(long j) {
        ...
        if (!(((AbstractSharedFlow) sharedFlowImpl).nCollectors == 0 || (abstractSharedFlowSlotArr = ((AbstractSharedFlow) sharedFlowImpl).slots) == null)) {
            ...
            while (i2 < length) {
                ...
                if (abstractSharedFlowSlot != null) {
                    SharedFlowSlot sharedFlowSlot = (SharedFlowSlot) abstractSharedFlowSlot;
                    if (sharedFlowSlot.index >= 0 && sharedFlowSlot.index < j6) {
                        j6 = sharedFlowSlot.index;
                    }
                }
            }
            j4 = j6;
        ...
        long max = Math.max(this.replayIndex, j3 - ((long) Math.min(this.replay, i5)));
        ...
        updateBufferLocked(max, j9, j3, j7);
        cleanupTailLocked();
