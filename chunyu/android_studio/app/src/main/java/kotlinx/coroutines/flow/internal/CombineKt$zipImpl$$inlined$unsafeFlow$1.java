...
public final class CombineKt$zipImpl$$inlined$unsafeFlow$1 implements Flow<R> {
    ...
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        Object coroutineScope = CoroutineScopeKt.coroutineScope(new CombineKt$zipImpl$1$1(flowCollector, this.$flow2$inlined, this.$flow$inlined, this.$transform$inlined, null), continuation);
