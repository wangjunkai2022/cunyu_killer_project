...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        ...
        Object collect = flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.2
            ...
            public final Object emit$$forInline(Object obj, Continuation continuation2) {
                ...
                Object invoke = r2.invoke(obj, continuation2);
                InlineMarker.mark(0);
                flowCollector2.emit(invoke, continuation2);
                InlineMarker.mark(1);
    ...
    public Object collect$$forInline(final FlowCollector flowCollector, Continuation continuation) {
        ...
        final Function2 function2 = this.$transform$inlined$1;
        InlineMarker.mark(0);
        flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1.2
            @Override // kotlinx.coroutines.flow.FlowCollector
            /* Code decompiled incorrectly, please refer to instructions dump */
            public final java.lang.Object emit(T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
                /*
            ...
            public final Object emit$$forInline(Object obj, Continuation continuation2) {
                ...
                InlineMarker.mark(5);
                FlowCollector flowCollector2 = FlowCollector.this;
                Object invoke = function2.invoke(obj, continuation2);
                InlineMarker.mark(0);
                flowCollector2.emit(invoke, continuation2);
                InlineMarker.mark(1);
                return Unit.INSTANCE;
