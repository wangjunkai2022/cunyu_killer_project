...
public final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.m50isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1484successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1482closedJP2dKIU(Result.m46exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1469boximpl(obj3);
    }
}
