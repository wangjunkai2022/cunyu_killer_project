...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m43constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
    ...
    public static final void postFrameCallback(Choreographer choreographer2, CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.-$$Lambda$HandlerDispatcherKt$NWrjUWFCewCsx_vZHJuqZRuFzKg
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1460postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }

    /* renamed from: postFrameCallback$lambda-6 */
    public static final void m1460postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
