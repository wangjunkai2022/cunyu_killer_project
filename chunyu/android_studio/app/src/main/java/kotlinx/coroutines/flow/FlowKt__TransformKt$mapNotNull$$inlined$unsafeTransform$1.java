...
public final class FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1 implements Flow<R> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        ...
        Object collect = flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.2
    ...
    public Object collect$$forInline(final FlowCollector flowCollector, Continuation continuation) {
        ...
        final Function2 function2 = this.$transform$inlined$1;
        InlineMarker.mark(0);
        flow.collect(new Object() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$mapNotNull$$inlined$unsafeTransform$1.2
            @Override // kotlinx.coroutines.flow.FlowCollector
            /* Code decompiled incorrectly, please refer to instructions dump */
            public final java.lang.Object emit(T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
                /*
