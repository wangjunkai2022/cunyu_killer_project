...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        ...
        L_0x004a:
            ...
            r8.<init>(r7, r2)
            kotlin.jvm.functions.Function2 r2 = r6.$action$inlined     // Catch: all -> 0x008d
            r0.L$0 = r6     // Catch: all -> 0x008d
            r0.L$1 = r7     // Catch: all -> 0x008d
            r0.L$2 = r8     // Catch: all -> 0x008d
            r0.label = r4     // Catch: all -> 0x008d
            r4 = 6
            kotlin.jvm.internal.InlineMarker.mark(r4)     // Catch: all -> 0x008d
            java.lang.Object r2 = r2.invoke(r8, r0)     // Catch: all -> 0x008d
            r4 = 7
            kotlin.jvm.internal.InlineMarker.mark(r4)     // Catch: all -> 0x008d
