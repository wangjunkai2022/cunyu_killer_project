...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(ReceiveChannel<? extends E> receiveChannel, int i, CoroutineStart coroutineStart) {
        ...
        }), null, i, coroutineStart, new Function1<Throwable, Unit>(receiveChannel) { // from class: kotlinx.coroutines.channels.BroadcastKt$broadcast$1
            final /* synthetic */ ReceiveChannel<E> $this_broadcast;

            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: Multi-variable type inference failed */
            {
                this.$this_broadcast = r1;
            }
