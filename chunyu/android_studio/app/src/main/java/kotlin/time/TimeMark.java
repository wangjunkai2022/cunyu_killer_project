...
public abstract class TimeMark {
    ...
    public TimeMark m1447minusLRDsOJo(long j) {
        return mo1312plusLRDsOJo(Duration.m1370unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1351isNegativeimpl(mo1311elapsedNowUwyO8pc());
    }
