...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1311elapsedNowUwyO8pc() {
        return Duration.m1353minusLRDsOJo(this.mark.mo1311elapsedNowUwyO8pc(), m1313getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1312plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1354plusLRDsOJo(m1313getAdjustmentUwyO8pc(), j), null);
    }
}
