...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m1226getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m42boximpl(obj));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> r0 = m1226getResultxLWZpok();
                if (r0 == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(r0.m52unboximpl());
                }
            }
        }
    }
