...
public final class CombinedContext implements CoroutineContext, Serializable {
    ...
    public CombinedContext(CoroutineContext coroutineContext, CoroutineContext.Element element) {
        Intrinsics.checkNotNullParameter(coroutineContext, TtmlNode.LEFT);
    ...
    private final Object writeReplace() {
        ...
        fold(Unit.INSTANCE, new Function2<Unit, CoroutineContext.Element, Unit>(coroutineContextArr, intRef) { // from class: kotlin.coroutines.CombinedContext$writeReplace$1
