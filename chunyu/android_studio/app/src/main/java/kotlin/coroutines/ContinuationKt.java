...
public final class ContinuationKt {
    ...
    private static final <T> Continuation<T> Continuation(CoroutineContext coroutineContext, Function1<? super Result<? extends T>, Unit> function1) {
        ...
        return new Continuation<T>(function1) { // from class: kotlin.coroutines.ContinuationKt$Continuation$1
            ...
            public void resumeWith(Object obj) {
                this.$resumeWith.invoke(Result.m42boximpl(obj));
            }
        };
    }
    ...
    public static final <T> void startCoroutine(Function1<? super Continuation<? super T>, ? extends Object> function1, Continuation<? super T> continuation) {
        ...
        Result.Companion companion = Result.Companion;
        intercepted.resumeWith(Result.m43constructorimpl(Unit.INSTANCE));
    }
