...
public final class ConsoleKt {
    ...
    private static final void print(char[] cArr) {
        Intrinsics.checkNotNullParameter(cArr, Constant.PARAM_ERROR_MESSAGE);
