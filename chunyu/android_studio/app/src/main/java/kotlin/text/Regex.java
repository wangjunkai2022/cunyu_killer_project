...
public final class Regex implements Serializable {
    ...
    public final Set<RegexOption> getOptions() {
        ...
        CollectionsKt.retainAll(allOf, new Function1<RegexOption, Boolean>(flags) { // from class: kotlin.text.Regex$special$$inlined$fromInt$1
    ...
    public final Sequence<MatchResult> findAll(CharSequence charSequence, int i) {
        ...
        if (i >= 0 && i <= charSequence.length()) {
            return SequencesKt.generateSequence((Function0) new Function0<MatchResult>(charSequence, i) { // from class: kotlin.text.Regex$findAll$1
