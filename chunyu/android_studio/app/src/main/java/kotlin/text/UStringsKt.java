...
public final class UStringsKt {
    ...
    public static final String m1308toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1310toStringolVBNx4(short s, int i) {
    ...
    public static final String m1309toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1307toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m110unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m370unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m188unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m266unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m188unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m137constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m55boximpl(UByte.m61constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m188unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m137constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m315boximpl(UShort.m321constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m137constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            int i5 = i3 + 1;
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m390uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m137constructorimpl(i2 * r5);
            int r6 = UInt.m137constructorimpl(UInt.m137constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m215constructorimpl((long) i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m392ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m215constructorimpl(j2 * r9);
            long r4 = ULong.m215constructorimpl(ULong.m215constructorimpl(((long) UInt.m137constructorimpl(digitOf)) & 4294967295L) + r11);
