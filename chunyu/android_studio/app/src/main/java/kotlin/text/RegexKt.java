...
public final class RegexKt {
    ...
    public static final /* synthetic */ IntRange access$range(MatchResult matchResult) {
    ...
    private static final /* synthetic */ <T extends Enum<T> & FlagEnum> Set<T> fromInt(int i) {
        ...
        CollectionsKt.retainAll(enumSet, new Function1<T, Boolean>(i) { // from class: kotlin.text.RegexKt$fromInt$1$1
