            ...
            this._keys = new AbstractSet<K>(this) { // from class: kotlin.collections.AbstractMap$keys$1
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0011: RETURN  
                      ...
                      (wrap: kotlin.collections.AbstractMap<K, V> : 0x0000: IGET  (r0v0 kotlin.collections.AbstractMap<K, V> A[REMOVE]) = (r2v0 'this' kotlin.collections.AbstractMap$keys$1 A[IMMUTABLE_TYPE, THIS]) kotlin.collections.AbstractMap$keys$1.this$0 kotlin.collections.AbstractMap)
                     ...
                     in method: kotlin.collections.AbstractMap$keys$1.iterator():java.util.Iterator<K>, file: classes2.dex
                ...
                public java.util.Iterator<K> iterator() {
                    /*
                        r2 = this;
                        kotlin.collections.AbstractMap<K, V> r0 = r2.this$0
            ...
            this._values = new AbstractCollection<V>(this) { // from class: kotlin.collections.AbstractMap$values$1
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0011: RETURN  
                      ...
                      (wrap: java.util.Iterator : 0x0006: INVOKE  (r0v2 java.util.Iterator A[REMOVE]) = 
                      (wrap: java.util.Set : 0x0002: INVOKE  (r0v1 java.util.Set A[REMOVE]) = 
                      (wrap: kotlin.collections.AbstractMap<K, V> : 0x0000: IGET  (r0v0 kotlin.collections.AbstractMap<K, V> A[REMOVE]) = (r2v0 'this' kotlin.collections.AbstractMap$values$1 A[IMMUTABLE_TYPE, THIS]) kotlin.collections.AbstractMap$values$1.this$0 kotlin.collections.AbstractMap)
                     type: VIRTUAL call: kotlin.collections.AbstractMap.entrySet():java.util.Set)
                     type: INTERFACE call: java.util.Set.iterator():java.util.Iterator)
                     call: kotlin.collections.AbstractMap$values$1$iterator$1.<init>(java.util.Iterator):void type: CONSTRUCTOR)
                     in method: kotlin.collections.AbstractMap$values$1.iterator():java.util.Iterator<V>, file: classes2.dex
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:270)
                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:233)
                    	at jadx.core.codegen.RegionGen.makeSimpleBlock(RegionGen.java:90)
                    	at jadx.core.dex.nodes.IBlock.generate(IBlock.java:15)
