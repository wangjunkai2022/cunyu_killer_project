...
class ArraysKt___ArraysJvmKt extends ArraysKt__ArraysKt {
    ...
    public static final <T> T[] plus(T[] tArr, T t) {
        ...
        tArr2[length] = t;
        Intrinsics.checkNotNullExpressionValue(tArr2, Constant.PARAM_RESULT);
        return tArr2;
    }
    ...
    public static final byte[] plus(byte[] bArr, byte b) {
        ...
        copyOf[length] = b;
        Intrinsics.checkNotNullExpressionValue(copyOf, Constant.PARAM_RESULT);
        return copyOf;
    }
    ...
    public static final <T> T[] plus(T[] tArr, T[] tArr2) {
        ...
        Intrinsics.checkNotNullExpressionValue(tArr3, Constant.PARAM_RESULT);
        return tArr3;
    }
