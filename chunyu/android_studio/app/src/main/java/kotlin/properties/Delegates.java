...
public final class Delegates {
    ...
    public final <T> ReadWriteProperty<Object, T> observable(T t, Function3<? super KProperty<?>, ? super T, ? super T, Unit> function3) {
        ...
        return new ObservableProperty<T>(t, function3) { // from class: kotlin.properties.Delegates$observable$1
    ...
    public final <T> ReadWriteProperty<Object, T> vetoable(T t, Function3<? super KProperty<?>, ? super T, ? super T, Boolean> function3) {
        Intrinsics.checkNotNullParameter(function3, "onChange");
        return new ObservableProperty<T>(t, function3) { // from class: kotlin.properties.Delegates$vetoable$1
            final /* synthetic */ T $initialValue;
            ...
            protected boolean beforeChange(KProperty<?> kProperty, T t2, T t3) {
                Intrinsics.checkNotNullParameter(kProperty, "property");
                return this.$onChange.invoke(kProperty, t2, t3).booleanValue();
            }
        };
    }
}
