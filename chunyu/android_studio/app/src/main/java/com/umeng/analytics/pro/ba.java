...
public abstract class ba<T extends ba<?, ?>, F extends ax> implements aq<T, F> {
    private static final Map<Class<? extends bx>, by> c;
    protected Object a;
    protected F b;

    protected abstract F a(short s);

    protected abstract Object a(bp bpVar, bk bkVar) throws aw;

    protected abstract Object a(bp bpVar, short s) throws aw;

    protected abstract void a(bp bpVar) throws aw;

    protected abstract void b(F f, Object obj) throws ClassCastException;

    protected abstract void b(bp bpVar) throws aw;

    protected abstract bk c(F f);

    protected abstract bu d();
