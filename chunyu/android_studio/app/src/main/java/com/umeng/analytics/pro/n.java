...
public class n {
    ...
    public void a(Object obj, int i) {
        if (AnalyticsConfig.enable) {
            if (i != 8213) {
                ...
                Context context3 = a;
                UMWorkDispatch.sendEventEx(context3, a.C, CoreProtocol.getInstance(context3), null, 5000);
            }
        }
    }
    ...
    private void r() {
        ...
        try {
            if (s() && (context = a) != null && (sharedPreferences = PreferenceWrapper.getDefault(context)) != null && sharedPreferences.getLong(l, 0) == 0) {
    ...
    private boolean s() {
        ...
        try {
            ...
            return sharedPreferences.getLong(m, -1) != 0;
        } catch (Throwable unused) {
            return false;
        }
    }
