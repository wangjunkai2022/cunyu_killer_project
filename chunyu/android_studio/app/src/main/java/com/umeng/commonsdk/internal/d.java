...
public class d {
    public static void a(Context context) {
        try {
            ...
            JSONObject buildEnvelopeWithExtHeader = UMEnvelopeBuild.buildEnvelopeWithExtHeader(context, jSONObject, d(context), UMServerURL.PATH_ANALYTICS, ai.aA, a.e);
    ...
    private static void j(Context context) {
        try {
            ...
            UMWorkDispatch.sendEvent(context, a.v, b.a(context).a(), null, 5000);
        } catch (Throwable th) {
        ...
        if (!(context == null || (l = a.l((applicationContext = context.getApplicationContext()))) == null)) {
            try {
                if (Build.VERSION.SDK_INT >= 16) {
                    jSONObject.put(ai.aF, l.totalMem);
                }
