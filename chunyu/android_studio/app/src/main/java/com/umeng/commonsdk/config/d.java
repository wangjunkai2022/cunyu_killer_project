...
public class d {
    ...
    public static String[] k = new String[EnumC0057d.values().length];
    ...
    static {
        ...
        if (strArr4 != null && strArr4.length > 0) {
            for (int i5 = 0; i5 < EnumC0057d.values().length; i5++) {
                k[i5] = EnumC0057d.values()[i5].toString();
            }
            Map<String, String[]> map4 = l;
            if (map4 != null) {
                map4.put(EnumC0057d.class.getName(), k);
            }
        }
    }
