...
public class aj implements aq<aj, e>, Serializable, Cloneable {
    ...
    private static final bk s = new bk(SessionDescription.ATTR_LENGTH, (byte) 8, 6);
    private static final bk t = new bk("entity", (byte) 11, 7);
    private static final bk u = new bk(TPDownloadProxyEnum.USER_GUID, (byte) 11, 8);
    ...
    static {
        ...
        enumMap.put((EnumMap) e.LENGTH, (e) new bc(SessionDescription.ATTR_LENGTH, (byte) 1, new bd((byte) 8)));
        enumMap.put((EnumMap) e.ENTITY, (e) new bc("entity", (byte) 1, new bd((byte) 11, true)));
        enumMap.put((EnumMap) e.GUID, (e) new bc(TPDownloadProxyEnum.USER_GUID, (byte) 1, new bd((byte) 11)));
