...
public class b implements aq<b, e>, Serializable, Cloneable {
    ...
    private static final bk g = new bk("identity", (byte) 11, 1);
    ...
    static {
        ...
        j = hashMap;
        hashMap.put(bz.class, new C0063b());
    ...
    /* loaded from: classes3.dex */
    private static class C0063b implements by {
        private C0063b() {
        }
