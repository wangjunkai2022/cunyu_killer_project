    ...
    void a(Context context, String str) {
        ...
        if (!UMUtils.isMainProgress(a)) {
            ...
            try {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.j, CoreProtocol.getInstance(context2), jSONObject);
            } catch (Throwable th) {
                if (MLog.DEBUG) {
                    MLog.e(th);
                }
    ...
    public void h() {
        try {
            ...
            if (context != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.k, CoreProtocol.getInstance(context2), Long.valueOf(currentTimeMillis));
                Context context3 = a;
                UMWorkDispatch.sendEvent(context3, n.a.g, CoreProtocol.getInstance(context3), Long.valueOf(currentTimeMillis));
            }
    ...
    public void i() {
        try {
            ...
            if (context != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.h, CoreProtocol.getInstance(context2), Long.valueOf(System.currentTimeMillis()));
                Context context3 = a;
                UMWorkDispatch.sendEvent(context3, n.a.d, CoreProtocol.getInstance(context3), null);
                Context context4 = a;
                UMWorkDispatch.sendEvent(context4, 4099, CoreProtocol.getInstance(context4), null);
                Context context5 = a;
                UMWorkDispatch.sendEvent(context5, n.a.i, CoreProtocol.getInstance(context5), null);
            }
        } catch (Throwable unused) {
        }
        ISysListener iSysListener = this.b;
    ...
    public void a(String str, String str2) {
        try {
            ...
            if (context != null) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.e, CoreProtocol.getInstance(context2), jSONObject);
                Context context3 = a;
    ...
    public void j() {
        try {
            ...
            if (context != null) {
                ...
                jSONObject.put("ts", currentTimeMillis);
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.f, CoreProtocol.getInstance(context2), jSONObject);
                Context context3 = a;
                UMWorkDispatch.sendEvent(context3, n.a.o, CoreProtocol.getInstance(context3), jSONObject);
            }
        } catch (Throwable th) {
    ...
    public synchronized void a(Context context, String str, Object obj) {
        ...
        if (!TextUtils.isEmpty(str) && obj != null) {
            if (!str.equals(z) && !str.equals(A) && !str.equals(B) && !str.equals(C) && !str.equals(D)) {
                ...
                Context context2 = a;
                UMWorkDispatch.sendEvent(context2, n.a.r, CoreProtocol.getInstance(context2), this.k.toString());
                return;
            } else {
