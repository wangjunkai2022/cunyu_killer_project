...
public class a implements UMImprintChangeCallback {
    ...
    private static FileObserverC0058a i = null;
    ...
    public a(Context context, Handler handler) {
        ...
        try {
            if (a == null) {
                ...
                handlerThread.start();
                if (i == null) {
                    FileObserverC0058a aVar = new FileObserverC0058a(UMFrUtils.getEnvelopeDirPath(context));
                    i = aVar;
                    aVar.startWatching();
    ...
    /* loaded from: classes3.dex */
    static class FileObserverC0058a extends FileObserver {
        public FileObserverC0058a(String str) {
            super(str);
        }
