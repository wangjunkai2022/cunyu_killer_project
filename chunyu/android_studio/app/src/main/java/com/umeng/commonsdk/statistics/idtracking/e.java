...
public class e {
    ...
    private void a(c cVar) {
        if (cVar != null && cVar.a != null) {
            if (cVar.a.containsKey(TPDownloadProxyEnum.USER_MAC) && !FieldManager.allow(b.h)) {
                cVar.a.remove(TPDownloadProxyEnum.USER_MAC);
            }
            if (cVar.a.containsKey("imei") && !FieldManager.allow(b.g)) {
                cVar.a.remove("imei");
            }
