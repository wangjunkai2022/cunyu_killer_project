...
public class e implements aq<e, EnumC0066e>, Serializable, Cloneable {
    ...
    private static final bk i = new bk(TPDownloadProxyEnum.USER_GUID, (byte) 11, 3);
    ...
    static {
        ...
        enumMap.put((EnumMap) EnumC0066e.GUID, (EnumC0066e) new bc(TPDownloadProxyEnum.USER_GUID, (byte) 1, new bd((byte) 11)));
