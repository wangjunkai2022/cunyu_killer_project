        ...
        if (i == 0) {
            ...
            try {
                if (Intrinsics.areEqual(str2, "asset")) {
                    ...
                    Glide.with(context).asBitmap().timeout(5000).load(Uri.parse(Intrinsics.stringPlus(Util.ANDROID_ASSET_URL, str))).into((RequestBuilder) new CustomTarget<Bitmap>(safeContinuation2, str4) { // from class: com.github.florent37.assets_audio_player.notification.ImageDownloader$getBitmap$2$1$1
                        ...
                        public void onLoadFailed(Drawable drawable) {
                            ...
                            continuation.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(new Exception(Intrinsics.stringPlus("failed to download ", this.$filePath)))));
                        }
                        ...
                        public void onResourceReady(Bitmap bitmap, Transition<? super Bitmap> transition) {
                            ...
                            Continuation<Bitmap> continuation = this.$continuation;
                            Result.Companion companion = Result.Companion;
                            continuation.resumeWith(Result.m43constructorimpl(bitmap));
                        }
                    });
                    ...
                    Glide.with(context).asBitmap().timeout(5000).load(str4).into((RequestBuilder) new CustomTarget<Bitmap>(context, safeContinuation2, str4) { // from class: com.github.florent37.assets_audio_player.notification.ImageDownloader$getBitmap$2$1$2
                        ...
                        public void onLoadFailed(Drawable drawable) {
                            try {
                                ...
                                continuation2.resumeWith(Result.m43constructorimpl(decodeResource));
                            } catch (Throwable unused) {
                                Continuation<Bitmap> continuation3 = this.$continuation;
                                Result.Companion companion3 = Result.Companion;
                                continuation3.resumeWith(Result.m43constructorimpl(ResultKt.createFailure(new Exception(Intrinsics.stringPlus("failed to download ", this.$filePath)))));
                            }
                        }
