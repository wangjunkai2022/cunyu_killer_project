    ...
    public final void updateNotifPosition() {
        ...
        if (audioMetas != null) {
            ...
            if (audioMetas != null) {
                ...
                if (audioMetas != null) {
                    NotificationService.Companion.updatePosition(this.context, isPlaying(), this._positionMs, (float) this.playSpeed);
                }
            }
        }
    }
