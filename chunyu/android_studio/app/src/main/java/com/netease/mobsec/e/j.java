...
public class j {
    ...
    public static byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            if (i2 % 2 == 0) {
                int i3 = i2 / 2;
                bArr3[i2] = (byte) (((bArr[i3] & 128) >>> 0) | ((bArr2[i3] & 16) >>> 4) | ((bArr2[i3] & 32) >>> 3) | ((bArr2[i3] & SignedBytes.MAX_POWER_OF_TWO) >>> 2) | ((bArr2[i3] & 128) >>> 1) | ((bArr[i3] & 16) >>> 3) | ((bArr[i3] & 32) >>> 2) | ((bArr[i3] & SignedBytes.MAX_POWER_OF_TWO) >>> 1) | bArr3[i2]);
            } else {
                int i4 = i2 / 2;
