...
public class f {
    ...
    public class c extends Thread {
        ...
        public void run() {
            try {
                ...
                if (b.isEmpty() || new JSONObject(b).optInt(Constant.PARAM_ERROR_CODE, -1) != 200) {
    ...
    private String j() throws SecException {
        ...
        try {
            ...
            String t2 = x.t();
            q = t2;
            String[] strArr = {n, o, "", t2, Short.toString(n2), l2, b2, str2, a3, this.d, this.j, valueOf, str};
            synchronized (f.class) {
                a2 = this.e.a(strArr);
            }
            return a2;
    ...
    private String k() throws SecException {
        ...
        try {
            ...
            q = x.t();
            String[] strArr = {n, o, "", s, b3, l2, Short.toString(n2), q, a2, this.d, this.j, this.h, this.i, valueOf};
            synchronized (f.class) {
                b2 = this.e.b(strArr);
            }
            return b2;
