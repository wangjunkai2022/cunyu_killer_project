...
public final class SVGAParser {
    ...
    /* compiled from: SVGAParser.kt */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0016\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J`\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\n2\u0006\u0010\f\u001a\u00020\r2!\u0010\u000e\u001a\u001d\u0012\u0013\u0012\u00110\u0010¢\u0006\f\b\u0011\u0012\b\b\u0012\u0012\u0004\b\b(\u0013\u0012\u0004\u0012\u00020\u000b0\u000f2%\u0010\u0014\u001a!\u0012\u0017\u0012\u00150\u0015j\u0002`\u0016¢\u0006\f\b\u0011\u0012\b\b\u0012\u0012\u0004\b\b(\u0017\u0012\u0004\u0012\u00020\u000b0\u000fH\u0016R\u001a\u0010\u0003\u001a\u00020\u0004X\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0005\u0010\u0006\"\u0004\b\u0007\u0010\b¨\u0006\u0018"}, d2 = {"Lcom/opensource/svgaplayer/SVGAParser$FileDownloader;", "", "()V", "noCache", "", "getNoCache", "()Z", "setNoCache", "(Z)V", "resume", "Lkotlin/Function0;", "", ImagesContract.URL, "Ljava/net/URL;", "complete", "Lkotlin/Function1;", "Ljava/io/InputStream;", "Lkotlin/ParameterName;", "name", "inputStream", "failure", "Ljava/lang/Exception;", "Lkotlin/Exception;", "e", BuildConfig.LIBRARY_PACKAGE_NAME}, k = 1, mv = {1, 1, 15})
    /* loaded from: classes2.dex */
    ...
    public final void decodeFromAssets(String str, ParseCompletion parseCompletion, PlayCallback playCallback) {
        ...
        logUtils.info(TAG, "================ decode " + str + " from assets ================");
    ...
    public final void decodeFromInputStream(InputStream inputStream, String str, ParseCompletion parseCompletion, boolean z, PlayCallback playCallback, String str2) {
        ...
        LogUtils logUtils = LogUtils.INSTANCE;
        logUtils.info(TAG, "================ decode " + str2 + " from input stream ================");
    ...
    public final void invokeErrorCallback(Exception exc, ParseCompletion parseCompletion, String str) {
        ...
        LogUtils logUtils2 = LogUtils.INSTANCE;
        logUtils2.error(TAG, str + " parse error", exc);
        ...
        try {
            ...
            if (file2 != null) {
                try {
                    ...
                    LogUtils.INSTANCE.error(TAG, str2 + " movie.spec change to entity fail", e2);
                    buildCacheDir.delete();
                    file2.delete();
                    throw e2;
                }
    ...
    public final void unzip(InputStream inputStream, String str) {
        ...
        try {
            ...
            LogUtils.INSTANCE.error(TAG, "================ unzip error ================");
            Exception exc2 = e;
            LogUtils.INSTANCE.error(TAG, "error", exc2);
