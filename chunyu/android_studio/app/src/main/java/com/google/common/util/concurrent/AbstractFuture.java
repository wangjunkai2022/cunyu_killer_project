    ...
    private static final class UnsafeAtomicHelper extends AtomicHelper {
        ...
        static {
            ...
            try {
                ...
                WAITER_NEXT_OFFSET = unsafe.objectFieldOffset(Waiter.class.getDeclaredField(NotificationAction.ACTION_NEXT));
                UNSAFE = unsafe;
            } catch (Exception e2) {
