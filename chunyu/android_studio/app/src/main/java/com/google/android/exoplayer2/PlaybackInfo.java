...
public final class PlaybackInfo {
    ...
    public static PlaybackInfo createDummy(TrackSelectorResult trackSelectorResult) {
        return new PlaybackInfo(Timeline.EMPTY, PLACEHOLDER_MEDIA_PERIOD_ID, C.TIME_UNSET, 0, 1, null, false, TrackGroupArray.EMPTY, trackSelectorResult, ImmutableList.of(), PLACEHOLDER_MEDIA_PERIOD_ID, false, 0, PlaybackParameters.DEFAULT, 0, 0, 0, false, false);
    }
