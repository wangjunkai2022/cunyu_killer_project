...
public final class TtmlNode {
        ...
        if (isActive(j)) {
            ...
            while (true) {
                ...
                if (it.hasNext()) {
                    ...
                    if (i != intValue) {
                        applyStyleToOutput(map, (Cue.Builder) Assertions.checkNotNull(map3.get(key)), i, intValue, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
                    }
                }
            }
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i, int i2, int i3) {
        ...
        if (resolveStyle != null) {
            TtmlRenderUtil.applyStylesToSpan(spannableStringBuilder, i, i2, resolveStyle, this.parent, map, i3);
    ...
    private static void cleanUpText(SpannableStringBuilder spannableStringBuilder) {
        ...
        for (DeleteTextSpan deleteTextSpan : deleteTextSpanArr) {
