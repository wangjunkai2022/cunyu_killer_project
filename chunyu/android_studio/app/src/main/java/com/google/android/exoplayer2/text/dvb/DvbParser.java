...
final class DvbParser {
    ...
    private static RegionComposition parseRegionComposition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i5 > 0) {
            ...
            sparseArray.put(readBits10, new RegionObject(readBits11, readBits12, readBits13, readBits14, i6, i2));
            readBits9 = readBits9;
            i4 = 2;
            i3 = 16;
        }
    ...
    private static int[] generateDefault8BitClutEntries() {
        ...
        for (int i = 0; i < iArr.length; i++) {
            ...
            if (i < 8) {
                ...
                int i5 = i & TPOptionalID.OPTION_ID_BEFORE_LONG_DEMXUER_TYPE;
                int i6 = 170;
                int i7 = 85;
                if (i5 == 0) {
            ...
            if (readBits != 240) {
                switch (readBits) {
                    ...
                    case 17:
                        ...
                        paint2BitPixelCodeString = paint4BitPixelCodeString(parsableBitArray, iArr, bArr4, i4, i5, paint, canvas);
                        parsableBitArray.byteAlign();
                        i4 = paint2BitPixelCodeString;
                        break;
                    case 18:
