    ...
    public StyledPlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            try {
                ...
                i6 = obtainStyledAttributes.getColor(R.styleable.StyledPlayerView_shutter_background_color, 0);
                ...
                i4 = obtainStyledAttributes.getInt(R.styleable.StyledPlayerView_surface_type, 1);
                i3 = obtainStyledAttributes.getInt(R.styleable.StyledPlayerView_resize_mode, 0);
        ...
        if (styledPlayerControlView != null) {
            ...
            z9 = 0;
            this.controller = new StyledPlayerControlView(context, null, 0, attributeSet);
