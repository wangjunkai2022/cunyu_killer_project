...
public final class TreeRangeMap<K extends Comparable, V> implements RangeMap<K, V> {
    ...
    public class SubRangeMap implements RangeMap<K, V> {
        ...
        public Range<K> span() {
            ...
            if (floorEntry == null || ((RangeMapEntry) floorEntry.getValue()).getUpperBound().compareTo((Cut<K>) this.subRange.lowerBound) <= 0) {
            ...
            if (lowerEntry != null) {
                if (((RangeMapEntry) lowerEntry.getValue()).getUpperBound().compareTo((Cut<K>) this.subRange.upperBound) >= 0) {
