...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        if (track != null) {
            this.trackBundles.put(0, new TrackBundle(extractorOutput.track(0, track.type), new TrackSampleTable(this.sideloadedTrack, new long[0], new int[0], 0, new long[0], new int[0], 0), new DefaultSampleValues(0, 0, 0, 0)));
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), j, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.-$$Lambda$fN3-4mToiYIj1aT5w0vidExaojw
    ...
    private void initExtraTracks() {
        ...
        this.emsgTrackOutputs = (TrackOutput[]) Util.nullSafeArrayCopy(this.emsgTrackOutputs, i);
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (this.emsgTrackOutputs.length != 0) {
            ...
            if (parseFullAtomVersion == 0) {
                ...
                long j6 = j5 != C.TIME_UNSET ? j5 + j4 : -9223372036854775807L;
                str2 = str3;
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, int i2, ParsableByteArray parsableByteArray, int i3) throws ParserException {
        ...
        while (i8 < i7) {
            ...
            if (z10) {
                ...
                z4 = z8;
                z3 = z9;
                iArr2[i8] = (int) ((((long) parsableByteArray.readInt()) * 1000000) / j2);
            } else {
                z5 = z10;
                z4 = z8;
                z3 = z9;
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        while (i < readUnsignedShort) {
            ...
            if ((readInt & Integer.MIN_VALUE) == 0) {
                ...
                jArr3[i] = j6;
                j5 += readUnsignedInt2;
                j6 = Util.scaleLargeTimestamp(j5, 1000000, readUnsignedInt);
                jArr2[i] = j6 - jArr3[i];
                parsableByteArray.skipBytes(4);
                j4 += (long) iArr[i];
                i++;
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i8 == 0) {
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = trackOutput.sampleData((DataReader) extractorInput, i8, false);
                    }
