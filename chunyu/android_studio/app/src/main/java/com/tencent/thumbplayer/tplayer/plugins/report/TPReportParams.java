...
public class TPReportParams {
    ...
    public class BufferingOnceParams {
        ...
        public void paramsToJson(JSONObject jSONObject) {
            try {
                ...
                jSONObject.put(ImagesContract.URL, this.urlString);
                jSONObject.put(Constant.PARAM_ERROR_CODE, this.errCodeString);
        ...
        public void paramsToProperties(a aVar) {
            ...
            aVar.a(ImagesContract.URL, this.urlString);
            aVar.a(Constant.PARAM_ERROR_CODE, this.errCodeString);
        }
    ...
    public class CommonParams {
        ...
        public void paramsToProperties(a aVar) {
            ...
            aVar.a(Player.AUDIO_TYPE_NETWORK, this.networkTypeInt);
            aVar.a("speed", this.networkSpeedInt);
            aVar.a("device", this.deviceNameString);
            aVar.a(ai.z, this.deviceResolutionString);
    ...
    public class FirstLoadParams {
        ...
        public void paramsToJson(JSONObject jSONObject) {
            try {
                ...
                jSONObject.put(ImagesContract.URL, this.cdnUrlString);
        ...
        public void paramsToProperties(a aVar) {
            ...
            aVar.a(ImagesContract.URL, this.cdnUrlString);
    ...
    public class LoadSubtitleParams {
        ...
        public void paramsToJson(JSONObject jSONObject) {
            try {
                ...
                jSONObject.put(ImagesContract.URL, this.subtitleUrlString);
        ...
        public void paramsToProperties(a aVar) {
            ...
            aVar.a(ImagesContract.URL, this.subtitleUrlString);
    ...
    public class RedirectParams {
        ...
        public void paramsToJson(JSONObject jSONObject) {
            try {
                jSONObject.put("etime", this.endTimeUnix);
                jSONObject.put(ImagesContract.URL, this.redirectedUrlString);
                jSONObject.put("vt", this.cdnTypeInt);
        ...
        public void paramsToProperties(a aVar) {
            aVar.a("etime", this.endTimeUnix);
            aVar.a(ImagesContract.URL, this.redirectedUrlString);
            aVar.a("vt", this.cdnTypeInt);
