...
public class i {
    ...
    private static void a(XmlSerializer xmlSerializer, ITPMediaAsset iTPMediaAsset) {
        ...
        if (extraParam != null) {
            a(xmlSerializer, extraParam, ITPMediaAssetExtraParam.TP_PLAYER_EXTRA_PARAM_HLS_PREFERRED_AUDIO);
            a(xmlSerializer, extraParam, ITPMediaAssetExtraParam.TP_PLAYER_EXTRA_PARAM_HLS_PREFERRED_SUBTITLE);
            a(xmlSerializer, extraParam, ITPMediaAssetExtraParam.TP_PLAYER_EXTRA_PARAM_HLS_PREFERRED_VIDEO);
        }
    }
