...
public class g {
    ...
    public boolean a(String str, final a aVar) {
        ...
        try {
            ...
            final int i = jSONObject.getInt(Constant.PARAM_ERROR_CODE);
            final String optString = jSONObject.optString(Constant.PARAM_ERROR_MESSAGE);
    ...
    private String l() {
        String format = String.format("%s/%d/%s", "https://playvideo.qcloud.com/getplayinfo/v4", Integer.valueOf(this.c.getAppId()), this.c.getFileId());
        String str = null;
        if (this.c.getPSign() != null) {
            str = a((String) null, this.c.getPSign(), (String) null);
        }
        if (!TextUtils.isEmpty(str)) {
            format = format + "?" + str;
        }
    ...
    private String a(String str, String str2, String str3) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            ...
            TXCLog.i("TXCPlayInfoProtocolV4", "V4 protocol send request fileId : " + this.c.getFileId() + " | overlayKey: " + this.g + " | overlayIv: " + this.h);
