...
public class TXCStreamUploader extends com.tencent.liteav.basic.module.a implements b {
        ...
        if (this.mIsPushing) {
            if (!this.mRtmpProxyEnable) {
                ...
                if (!this.mEnableNearestIP || this.mLastNetworkType == h.d(this.mContext)) {
                    ...
                    TXCLog.e(TAG, "reconnect retry count:" + this.mRetryCount + " retry limit:" + this.mParam.e);
                ...
                TXCLog.e(TAG, "reconnect network switch from " + this.mLastNetworkType + " to " + h.d(this.mContext));
                this.mLastNetworkType = h.d(this.mContext);
    ...
    public void reportNetStatus() {
        ...
        setStatusValue(TXLiteAVCode.WARNING_AUDIO_RECORDING_WRITE_FAIL, Long.valueOf(j5));
