...
public final class TPMediaDecoderInfo implements Serializable {
    ...
    private int getMaxHeight(MediaCodecInfo.VideoCapabilities videoCapabilities) {
        return (videoCapabilities != null ? videoCapabilities.getSupportedHeights() : new Range<>(0, Integer.valueOf((int) DEFAULT_MAX_HEIGHT))).getUpper().intValue();
    }
    ...
    private void reset() {
        ...
        this.maxLumaHeight = DEFAULT_MAX_HEIGHT;
