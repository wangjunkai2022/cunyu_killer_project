...
public final class TPMediaCodecProfileLevel {
    ...
    public static final HashMap<Integer, Integer> hevcLumaSampleMap = new HashMap<>();
    public static final HashMap<Integer, Integer> vp9LumaSampleMap = new HashMap<>();
    public static final HashMap<Integer, Integer> av1LumaSampleMap = new HashMap<>();
    ...
    static {
        ...
        avcLumaSampleMap.put(128, 414720);
        avcLumaSampleMap.put(256, 414720);
        avcLumaSampleMap.put(512, Integer.valueOf((int) TXLiveConstants.VIDEO_RESOLUTION_720X1280));
        ...
        hevcLumaSampleMap.put(128, 552960);
        hevcLumaSampleMap.put(256, 983040);
        ...
        hevcLumaSampleMap.put(16777216, 35651584);
        hevcLumaSampleMap.put(Integer.valueOf((int) HEVCHighTierLevel62), 35651584);
        ...
        vp9LumaSampleMap.put(128, 2228224);
        vp9LumaSampleMap.put(256, 8912896);
        ...
        av1LumaSampleMap.put(128, 1065024);
        av1LumaSampleMap.put(256, 2359296);
    ...
    public static int getAVCMaxLumaSample(int i) {
        return (avcLumaSampleMap.containsKey(Integer.valueOf(i)) ? avcLumaSampleMap.get(Integer.valueOf(i)) : avcLumaSampleMap.get(256)).intValue();
    }

    public static int getHEVCMaxLumaSample(int i) {
        return (hevcLumaSampleMap.containsKey(Integer.valueOf(i)) ? hevcLumaSampleMap.get(Integer.valueOf(i)) : hevcLumaSampleMap.get(64)).intValue();
    }

    public static int getVP9MaxLumaSample(int i) {
        return (vp9LumaSampleMap.containsKey(Integer.valueOf(i)) ? vp9LumaSampleMap.get(Integer.valueOf(i)) : vp9LumaSampleMap.get(16)).intValue();
    }
}
