...
public class TPOptionalID {
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_AUDIO_FRAME_CALLBACK", type = 3, value = TPNativePlayerInitConfig.BOOL_ENABLE_AUDIO_FRAME_CALLBACK)
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_AUDIO_SYNC_FREE_RUN", type = 3, value = 415)
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_AUDIO_SYNC_FREE_RUN = 415;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_DROPFRAME_BY_REFRESHRATE", type = 3, value = TPNativePlayerInitConfig.BOOL_ENABLE_DROPFRAME_BY_REFRESHRATE)
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_MEDIA_CODEC_REUSE", type = 3, value = TPNativePlayerInitConfig.BOOL_ENABLE_MEDIA_CODEC_REUSE)
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_VIDEO_FRAME_CALLBACK", type = 3, value = TPNativePlayerInitConfig.BOOL_ENABLE_VIDEO_FRAME_CALLBACK)
