...
public class StatusBucket {
    ...
    public static void testStatusBucket() {
        ...
        statusBucket.setIntStatus(ExifInterface.GPS_MEASUREMENT_2D, 2, 2);
        statusBucket.setLongStatus(ExifInterface.GPS_MEASUREMENT_3D, 3, 3);
        ...
        String str3 = TAG;
        TXCLog.e(str3, "test_status_bucket: id:2, key:2, value:" + statusBucket.getIntStatus(ExifInterface.GPS_MEASUREMENT_2D, 2));
        String str4 = TAG;
        TXCLog.e(str4, "test_status_bucket: id:3, key:3, value:" + statusBucket.getLongStatus(ExifInterface.GPS_MEASUREMENT_3D, 3));
        String str5 = TAG;
