...
public class a implements b {
    ...
    public int a(String str, int i) {
        ...
        TXCLog.i(TXLivePlayer.TAG, "===========================================================================================================================================================");
        TXCLog.i(TXLivePlayer.TAG, "=====  StartPlay url = " + str + " playType = " + i + " DeviceName = " + TXCBuild.Model() + " SDKVersion = " + TXCCommonUtil.getSDKID() + " , " + TXCCommonUtil.getSDKVersionStr() + "    ======");
        TXCLog.i(TXLivePlayer.TAG, "===========================================================================================================================================================");
        TXCLog.i(TXLivePlayer.TAG, "===========================================================================================================================================================");
        int i2 = this.C;
        if (i2 == -1 || i2 != i) {
    ...
    public void b(String str) {
        ...
        if (TextUtils.isEmpty(str) || str.contains(str3)) {
            ...
            sb.append(str2);
            TXCLog.i(TXLivePlayer.TAG, sb.toString());
        } else {
            TXCLog.i(TXLivePlayer.TAG, "callExperimentalAPI json:" + str);
        }
        try {
            ...
            if (string.equals("muteRemoteAudioInSpeaker")) {
                ...
                if (jSONObject2 != null && jSONObject2.has("payloadType")) {
                    ...
                    TXCLog.e(TXLivePlayer.TAG, "callExperimentalAPI[invalid param]: payloadType[" + i2 + "]");
                    return;
                }
                ...
                if (jSONObject2 == null) {
                    TXCLog.e(TXLivePlayer.TAG, "setEncryptionParams[lack parameter]");
                } else if (!jSONObject2.has(ImagesContract.URL)) {
                    TXCLog.e(TXLivePlayer.TAG, "setEncryptionParams[lack parameter]: url");
                } else if (!jSONObject2.has("encMode")) {
                    TXCLog.e(TXLivePlayer.TAG, "setEncryptionParams[lack parameter]: encMode");
                } else if (!jSONObject2.has("encKey")) {
                    TXCLog.e(TXLivePlayer.TAG, "setEncryptionParams[lack parameter]: encKey");
                } else if (!jSONObject2.has("encIV")) {
                    TXCLog.e(TXLivePlayer.TAG, "setEncryptionParams[lack parameter]: encIV");
                } else {
            ...
            if (TextUtils.isEmpty(str) || str.contains(str3)) {
                ...
                sb2.append(str3);
                TXCLog.e(TXLivePlayer.TAG, sb2.toString());
                return;
            }
    ...
    public void onNotifyEvent(int i, Bundle bundle) {
        ...
        if (i == 15001) {
            ...
            long j = ((long) bundle.getInt(TXLiveConstants.EVT_PLAY_PROGRESS_MS)) + this.A;
            if (j > 0) {
