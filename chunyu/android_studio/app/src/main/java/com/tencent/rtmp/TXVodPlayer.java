...
public class TXVodPlayer implements b, j {
    ...
    public int startPlay(String str) {
        ...
        TXCLog.i(TAG, "===========================================================================================================================================================");
        TXCLog.i(TAG, "===========================================================================================================================================================");
        TXCLog.i(TAG, "=====  StartPlay url = " + this.mPlayUrl + " SDKVersion = " + TXCCommonUtil.getSDKID() + " , " + TXCCommonUtil.getSDKVersionStr() + "    ====== player=" + hashCode());
        TXCLog.i(TAG, "===========================================================================================================================================================");
        TXCLog.i(TAG, "===========================================================================================================================================================");
        updateConfig();
    ...
    public void startPlay(TXPlayInfoParams tXPlayInfoParams) {
        if (tXPlayInfoParams != null) {
            ...
            new g(tXPlayInfoParams).a(new g.a() { // from class: com.tencent.rtmp.TXVodPlayer.1
                @Override // com.tencent.liteav.network.g.a
                public void a(g gVar, TXPlayInfoParams tXPlayInfoParams2) {
                    String str;
                    TXLog.i(TXVodPlayer.TAG, "onSuccess: protocol params = " + tXPlayInfoParams2.toString());
                    if (!TXVodPlayer.this.mIsStoped) {
                        if (!TextUtils.isEmpty(tXPlayInfoParams2.mPSign) && !TextUtils.isEmpty(gVar.h()) && !TextUtils.isEmpty(gVar.i())) {
                        ...
                        if (!TextUtils.isEmpty(a)) {
                            ...
                            Uri build = parse.buildUpon().query(str + "spfileid=" + tXPlayInfoParams2.getFileId() + "&spdrmtype=" + k + "&spappid=" + tXPlayInfoParams2.getAppId()).build();
                            StringBuilder sb = new StringBuilder();
                            sb.append("playVodURL: newurl = ");
                            sb.append(build.toString());
                            sb.append(" ;url= ");
                            sb.append(a);
                            TXCLog.i(TXVodPlayer.TAG, sb.toString());
                        ...
                        bundle.putString(TXLiveConstants.EVT_PLAY_URL, a);
                        bundle.putString(TXLiveConstants.EVT_PLAY_COVER_URL, gVar.b());
                        bundle.putString(TXLiveConstants.EVT_PLAY_NAME, gVar.d());
                        bundle.putString(TXLiveConstants.EVT_PLAY_DESCRIPTION, gVar.e());
                        bundle.putInt(TXLiveConstants.EVT_PLAY_DURATION, gVar.f());
                        TXVodPlayer.this.onNotifyEvent(2010, bundle);
                        TXCLog.i(TXVodPlayer.TAG, "onSuccess: Requested file information successfully");
                    }
                }

                @Override // com.tencent.liteav.network.g.a
                public void a(int i, String str) {
                    TXLog.w(TXVodPlayer.TAG, "onFail: errorCode = " + i + " message = " + str);
                    Bundle bundle = new Bundle();
                    ...
                    TXCLog.i(TXVodPlayer.TAG, "onError: eventId: -2306 description:" + str);
                }
            });
        }
    }
    ...
    public int stopPlay(boolean z) {
        ...
        TXCLog.i(TAG, "stopPlay needClearLastImg:" + z + " player=" + hashCode());
    ...
    public void pause() {
        TXCLog.i(TAG, "pause player=" + hashCode());
        h hVar = this.mPlayer;
        if (hVar != null) {
            hVar.a();
        }
    ...
    public void resume() {
        TXCLog.i(TAG, "resume player=" + hashCode());
        h hVar = this.mPlayer;
        if (hVar != null) {
            hVar.b();
        }
    ...
    public void onNetSuccess(i iVar) {
        if (iVar == this.mNetApi) {
            ...
            bundle.putString(TXLiveConstants.EVT_PLAY_COVER_URL, a.d());
            bundle.putString(TXLiveConstants.EVT_PLAY_NAME, a.h());
            bundle.putString(TXLiveConstants.EVT_PLAY_DESCRIPTION, a.i());
            if (a.f() != null) {
                bundle.putInt(TXLiveConstants.EVT_PLAY_DURATION, a.f().c());
            }
