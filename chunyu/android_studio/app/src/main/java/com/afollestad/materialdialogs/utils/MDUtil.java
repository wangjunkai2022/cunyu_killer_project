...
public final class MDUtil {
    ...
    public final void textChanged(EditText editText, Function1<? super CharSequence, Unit> function1) {
        ...
        editText.addTextChangedListener(new TextWatcher() { // from class: com.afollestad.materialdialogs.utils.MDUtil$textChanged$1
            ...
            public void afterTextChanged(Editable editable) {
                Intrinsics.checkParameterIsNotNull(editable, ai.az);
            }

            @Override // android.text.TextWatcher
            public void beforeTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                Intrinsics.checkParameterIsNotNull(charSequence, ai.az);
            }
    ...
    public final ColorStateList createColorSelector(Context context, int i, int i2) {
        ...
        int[] iArr2 = new int[3];
        if (i == 0) {
            i3 = resolveColor$default(this, context, null, Integer.valueOf(R.attr.colorControlNormal), null, 10, null);
        } else {
            i3 = i;
        }
        iArr2[0] = i3;
    ...
    public final <T extends View> void waitForWidth(T t, Function1<? super T, Unit> function1) {
        ...
        if (t.getMeasuredWidth() <= 0 || t.getMeasuredHeight() <= 0) {
            t.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(t, function1) { // from class: com.afollestad.materialdialogs.utils.MDUtil$waitForWidth$1
    ...
    public final <T extends View> void waitForHeight(T t, Function1<? super T, Unit> function1) {
        ...
        Intrinsics.checkParameterIsNotNull(function1, "block");
        if (t.getMeasuredWidth() <= 0 || t.getMeasuredHeight() <= 0) {
            t.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener(t, function1) { // from class: com.afollestad.materialdialogs.utils.MDUtil$waitForHeight$1
                final /* synthetic */ Function1 $block;
    ...
    public static /* synthetic */ void updatePadding$default(MDUtil mDUtil, View view, int i, int i2, int i3, int i4, int i5, Object obj) {
        ...
        mDUtil.updatePadding(view, i, i2, i3, i4);
    }
    ...
    public final void assertOneSet(String str, Object obj, Integer num) {
        Intrinsics.checkParameterIsNotNull(str, Constant.PARAM_METHOD);
