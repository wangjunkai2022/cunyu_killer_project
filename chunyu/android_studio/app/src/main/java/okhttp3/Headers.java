...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1581deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers of(String... strArr) {
            ...
            if (strArr.length % 2 == 0) {
                ...
                if (clone != null) {
                    ...
                    IntProgression step = RangesKt.step(RangesKt.until(0, strArr2.length), 2);
                    int first = step.getFirst();
                    int last = step.getLast();
                    int step2 = step.getStep();
        ...
        public final Headers m1583deprecated_of(String... strArr) {
            Intrinsics.checkNotNullParameter(strArr, "namesAndValues");
        ...
        /* renamed from: -deprecated_of */
        public final Headers m1582deprecated_of(Map<String, String> map) {
