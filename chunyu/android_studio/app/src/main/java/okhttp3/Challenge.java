...
public final class Challenge {
    ...
    public final String realm() {
        return this.authParams.get(ProtectionSpaceContract.FeedEntry.COLUMN_NAME_REALM);
    }
    ...
    public final String m1558deprecated_scheme() {
        return this.scheme;
    }
    ...
    public final Charset m1556deprecated_charset() {
        return charset();
    }
