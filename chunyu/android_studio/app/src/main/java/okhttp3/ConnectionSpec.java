...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1560deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1562deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1561deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
