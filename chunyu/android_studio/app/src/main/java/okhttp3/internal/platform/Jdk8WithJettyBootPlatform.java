...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    private static final class AlpnProvider implements InvocationHandler {
        ...
        public Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
            ...
            Intrinsics.checkNotNullParameter(method, Constant.PARAM_METHOD);
            if (objArr == null) {
                objArr = new Object[0];
            }
            ...
            if (!Intrinsics.areEqual(name, "unsupported") || !Intrinsics.areEqual(Void.TYPE, returnType)) {
                ...
                if ((Intrinsics.areEqual(name, "selectProtocol") || Intrinsics.areEqual(name, NotificationAction.ACTION_SELECT)) && Intrinsics.areEqual(String.class, returnType) && objArr.length == 1 && (objArr[0] instanceof List)) {
