...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> list) {
        ...
        if (this.publicSuffixListBytes != null) {
            ...
            if (str4 != null) {
                return StringsKt.split$default((CharSequence) (EXCEPTION_MARKER + str4), new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null);
            } else if (str == null && str2 == null) {
                return PREVAILING_RULE;
            } else {
                if (str == null || (list2 = StringsKt.split$default((CharSequence) str, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null)) == null) {
                    list2 = CollectionsKt.emptyList();
                }
                if (str2 == null || (list3 = StringsKt.split$default((CharSequence) str2, new char[]{FilenameUtils.EXTENSION_SEPARATOR}, false, 0, 6, (Object) null)) == null) {
