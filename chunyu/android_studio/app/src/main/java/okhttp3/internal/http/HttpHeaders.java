...
public final class HttpHeaders {
    ...
    public static final boolean promisesBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == 304) && Util.headersContentLength(response) == -1 && !StringsKt.equals("chunked", Response.header$default(response, com.google.common.net.HttpHeaders.TRANSFER_ENCODING, null, 2, null), true)) {
            return false;
        }
        return true;
    }
