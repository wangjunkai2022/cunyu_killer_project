    ...
    public static final class Pin {
        ...
        public final boolean matchesHostname(String str) {
            ...
            if (StringsKt.startsWith$default(this.pattern, "**.", false, 2, (Object) null)) {
                ...
                if (!StringsKt.regionMatches$default(str, str.length() - length3, this.pattern, 1, length3, false, 16, (Object) null) || StringsKt.lastIndexOf$default((CharSequence) str, (char) FilenameUtils.EXTENSION_SEPARATOR, length4 - 1, false, 4, (Object) null) != -1) {
                    return false;
                }
            }
            return true;
