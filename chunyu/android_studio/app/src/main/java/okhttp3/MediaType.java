...
public final class MediaType {
    ...
    public final String m1608deprecated_type() {
        return this.type;
    }
    ...
    public final String m1607deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1609deprecated_get(String str) {
        ...
        public final MediaType m1610deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
    }
