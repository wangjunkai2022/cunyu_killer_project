    ...
    public interface VideoPlayerApi {
        ...
        public final /* synthetic */ class CC {
            ...
            public static /* synthetic */ void lambda$setup$1(VideoPlayerApi videoPlayerApi, Object obj, BasicMessageChannel.Reply reply) {
                HashMap hashMap = new HashMap();
                try {
                    hashMap.put(Constant.PARAM_RESULT, videoPlayerApi.create(CreateMessage.fromMap((HashMap) obj)).toMap());
                } catch (Exception e) {
                    hashMap.put("error", Messages.wrapError(e));
                }
                reply.reply(hashMap);
            ...
            public static /* synthetic */ void lambda$setup$7(VideoPlayerApi videoPlayerApi, Object obj, BasicMessageChannel.Reply reply) {
                HashMap hashMap = new HashMap();
                try {
                    hashMap.put(Constant.PARAM_RESULT, videoPlayerApi.position(TextureMessage.fromMap((HashMap) obj)).toMap());
                } catch (Exception e) {
                    hashMap.put("error", Messages.wrapError(e));
                }
                reply.reply(hashMap);
