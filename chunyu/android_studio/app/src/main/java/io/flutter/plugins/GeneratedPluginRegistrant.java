...
public final class GeneratedPluginRegistrant {
    ...
    public static void registerWith(FlutterEngine flutterEngine) {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin assets_audio_player_web, com.github.florent37.assets_audio_player_web.AssetsAudioPlayerWebPlugin", e2);
        }
        try {
            flutterEngine.getPlugins().add(new CaptchaPluginFlutterPlugin());
        } catch (Exception e3) {
            Log.e(TAG, "Error registering plugin captcha_plugin_flutter, com.netease.nis.captcha_plugin_flutter.CaptchaPluginFlutterPlugin", e3);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin flutter_image_compress, com.example.flutterimagecompress.FlutterImageCompressPlugin", e7);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin flutter_vibrate, flutter.plugins.vibrate.VibratePlugin", e11);
        }
        try {
            flutterEngine.getPlugins().add(new FlutterWindowManagerPlugin());
        } catch (Exception e12) {
            Log.e(TAG, "Error registering plugin flutter_windowmanager, io.adaptant.labs.flutter_windowmanager.FlutterWindowManagerPlugin", e12);
        }
        try {
            flutterEngine.getPlugins().add(new FlutterYunCengKiwiPlugin());
        } catch (Exception e13) {
            Log.e(TAG, "Error registering plugin flutter_yun_ceng_kiwi, com.example.flutter_yun_ceng_kiwi.FlutterYunCengKiwiPlugin", e13);
        }
        try {
            flutterEngine.getPlugins().add(new GestureRecognitionPlugin());
        } catch (Exception e14) {
            Log.e(TAG, "Error registering plugin gesture_recognition, com.wx.gesture_recognition.GestureRecognitionPlugin", e14);
        }
        try {
            flutterEngine.getPlugins().add(new FlutterImageEditorPlugin());
        } catch (Exception e15) {
            Log.e(TAG, "Error registering plugin image_editor, top.kikt.flutter_image_editor.FlutterImageEditorPlugin", e15);
        }
        try {
            flutterEngine.getPlugins().add(new ImageGallerySaverPlugin());
        } catch (Exception e16) {
            Log.e(TAG, "Error registering plugin image_gallery_saver, com.example.imagegallerysaver.ImageGallerySaverPlugin", e16);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin image_save, com.samoy.image_save.ImageSavePlugin", e18);
        }
        try {
            flutterEngine.getPlugins().add(new InstallPlugin());
        } catch (Exception e19) {
            Log.e(TAG, "Error registering plugin install_plugin, com.zaihui.installplugin.InstallPlugin", e19);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin native_dialog, xyz.ipig.native_dialog.NativeDialogPlugin", e21);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin openinstall_flutter_plugin, io.openinstall.openinstall_flutter_plugin.OpeninstallFlutterPlugin", e23);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin plugin_yidun, com.example.plugin_yidun.PluginYidunPlugin", e27);
        }
        try {
        ...
        try {
            ...
            Log.e(TAG, "Error registering plugin super_network_kit, com.example.super_network_kit.SuperNetworkKitPlugin", e30);
        }
        try {
            flutterEngine.getPlugins().add(new SuperPlayerKitPlugin());
        } catch (Exception e31) {
            Log.e(TAG, "Error registering plugin super_player_kit, com.example.super_player_kit.SuperPlayerKitPlugin", e31);
        }
        try {
