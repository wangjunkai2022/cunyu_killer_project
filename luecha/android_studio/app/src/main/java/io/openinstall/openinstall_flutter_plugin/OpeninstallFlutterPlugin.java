            ...
            if ("getInstall".equalsIgnoreCase(methodCall.method)) {
                ...
                AnonymousClass1 r0 = new AppInstallAdapter() { // from class: io.openinstall.openinstall_flutter_plugin.OpeninstallFlutterPlugin.1
                    ...
                    public void onInstall(AppData appData) {
                        OpeninstallFlutterPlugin.this.channel.invokeMethod("onInstallNotification", OpeninstallFlutterPlugin.data2Map(appData));
                    }
                };
                if (num != null) {
                    i = num.intValue();
                ...
                AnonymousClass2 r02 = new AppInstallRetryAdapter() { // from class: io.openinstall.openinstall_flutter_plugin.OpeninstallFlutterPlugin.2
                    ...
                    public void onInstall(AppData appData, boolean z) {
                        ...
                        OpeninstallFlutterPlugin.this.channel.invokeMethod("onInstallNotification", data2Map);
                    }
                };
                if (num2 != null) {
                    i = num2.intValue();
        ...
        if (this.alwaysCallback) {
            AppInstall.getWakeUpAlwaysCallback(intent, new AppWakeUpListener() { // from class: io.openinstall.openinstall_flutter_plugin.OpeninstallFlutterPlugin.5
                ...
                public void onWakeUpFinish(AppData appData, Error error) {
                    if (error != null) {
                        Log.d("OpenInstallPlugin", "getWakeUpAlwaysCallback : " + error.toString());
                    }
                    OpeninstallFlutterPlugin.this.channel.invokeMethod("onWakeupNotification", OpeninstallFlutterPlugin.data2Map(appData));
                }
            });
        } else {
