...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    private void scheduleGracePeriodEnd() {
        ...
        final AnonymousClass4 r1 = new Runnable() { // from class: androidx.viewpager2.adapter.FragmentStateAdapter.4
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        void register(RecyclerView recyclerView) {
            ...
            AnonymousClass1 r2 = new ViewPager2.OnPageChangeCallback() { // from class: androidx.viewpager2.adapter.FragmentStateAdapter.FragmentMaxLifecycleEnforcer.1
            ...
            AnonymousClass2 r22 = new DataSetChangeObserver() { // from class: androidx.viewpager2.adapter.FragmentStateAdapter.FragmentMaxLifecycleEnforcer.2
