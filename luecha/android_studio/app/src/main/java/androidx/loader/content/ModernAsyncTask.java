...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    static {
        AnonymousClass1 r7 = new ThreadFactory() { // from class: androidx.loader.content.ModernAsyncTask.1
    ...
    public ModernAsyncTask() {
        AnonymousClass2 r0 = new WorkerRunnable<Params, Result>() { // from class: androidx.loader.content.ModernAsyncTask.2
        ...
        this.mWorker = r0;
        this.mFuture = new FutureTask<Result>(r0) { // from class: androidx.loader.content.ModernAsyncTask.3
