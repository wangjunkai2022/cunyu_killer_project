...
public final class RangeKt {
    ...
    public static final <T extends Comparable<? super T>> Range<T> plus(Range<T> range, T t) {
        Intrinsics.checkNotNullParameter(range, "$this$plus");
    ...
    public static final <T extends Comparable<? super T>> Range<T> and(Range<T> range, Range<T> range2) {
        Intrinsics.checkNotNullParameter(range, "$this$and");
        Intrinsics.checkNotNullParameter(range2, "other");
    ...
    public static final <T extends Comparable<? super T>> ClosedRange<T> toClosedRange(Range<T> range) {
        Intrinsics.checkNotNullParameter(range, "$this$toClosedRange");
    ...
    public static final <T extends Comparable<? super T>> Range<T> toRange(ClosedRange<T> closedRange) {
        Intrinsics.checkNotNullParameter(closedRange, "$this$toRange");
