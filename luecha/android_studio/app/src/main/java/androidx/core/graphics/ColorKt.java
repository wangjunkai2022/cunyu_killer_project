...
public final class ColorKt {
    ...
    public static final float component1(Color color) {
        Intrinsics.checkNotNullParameter(color, "$this$component1");
        return color.getComponent(0);
    }

    public static final float component2(Color color) {
        Intrinsics.checkNotNullParameter(color, "$this$component2");
        return color.getComponent(1);
    }

    public static final float component3(Color color) {
        Intrinsics.checkNotNullParameter(color, "$this$component3");
        return color.getComponent(2);
    }

    public static final float component4(Color color) {
        Intrinsics.checkNotNullParameter(color, "$this$component4");
        return color.getComponent(3);
    }

    public static final Color plus(Color color, Color color2) {
        Intrinsics.checkNotNullParameter(color, "$this$plus");
        Intrinsics.checkNotNullParameter(color2, ai.aD);
    ...
    public static final Color convertTo(Color color, ColorSpace.Named named) {
        Intrinsics.checkNotNullParameter(color, "$this$convertTo");
        Intrinsics.checkNotNullParameter(named, "colorSpace");
    ...
    public static final int toColorInt(String str) {
        Intrinsics.checkNotNullParameter(str, "$this$toColorInt");
