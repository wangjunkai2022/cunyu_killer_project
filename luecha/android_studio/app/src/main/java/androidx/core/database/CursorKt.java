...
public final class CursorKt {
    public static final byte[] getBlobOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getBlobOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Double getDoubleOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getDoubleOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Float getFloatOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getFloatOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Integer getIntOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getIntOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Long getLongOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getLongOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final Short getShortOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getShortOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
    ...
    public static final String getStringOrNull(Cursor cursor, int i) {
        Intrinsics.checkNotNullParameter(cursor, "$this$getStringOrNull");
        if (cursor.isNull(i)) {
            return null;
        }
