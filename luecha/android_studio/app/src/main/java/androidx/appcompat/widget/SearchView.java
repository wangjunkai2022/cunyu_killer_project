...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        AnonymousClass5 r1 = new View.OnClickListener() { // from class: androidx.appcompat.widget.SearchView.5
        ...
        AnonymousClass7 r2 = new TextView.OnEditorActionListener() { // from class: androidx.appcompat.widget.SearchView.7
        ...
        AnonymousClass8 r3 = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
        ...
        AnonymousClass9 r4 = new AdapterView.OnItemSelectedListener() { // from class: androidx.appcompat.widget.SearchView.9
