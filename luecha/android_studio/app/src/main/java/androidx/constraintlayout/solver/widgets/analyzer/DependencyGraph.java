...
public class DependencyGraph {
    ...
    public boolean directMeasure(boolean z) {
        ...
        while (it4.hasNext()) {
            ...
            if (z2 || next2.widget != this.container) {
                if (!next2.start.resolved || ((!next2.end.resolved && !(next2 instanceof GuidelineReference)) || (!next2.dimension.resolved && !(next2 instanceof ChainRun) && !(next2 instanceof GuidelineReference)))) {
                    z3 = false;
                    break;
                }
            }
