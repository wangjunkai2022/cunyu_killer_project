...
public final class MpegAudioUtil {
    ...
    private static final int[] BITRATE_V2 = {8000, 16000, 24000, 32000, MAX_RATE_BYTES_PER_SECOND, 48000, 56000, 64000, Ac3Util.AC3_MAX_RATE_BYTES_PER_SECOND, 96000, 112000, 128000, 144000, 160000};
