...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            this.currentStartBounds.set(f4 - (evaluate.currentStartWidth / 2.0f), f5, (this.fitModeResult.currentStartWidth / 2.0f) + f4, this.fitModeResult.currentStartHeight + f5);
            this.currentEndBounds.set(f4 - (this.fitModeResult.currentEndWidth / 2.0f), f5, f4 + (this.fitModeResult.currentEndWidth / 2.0f), this.fitModeResult.currentEndHeight + f5);
            ...
            this.shadowPaint.setShadowLayer(f6, (float) ((int) (calculateElevationDxMultiplier * f6)), f7, SHADOW_COLOR);
