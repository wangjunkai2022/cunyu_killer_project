...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    public final class ComplementRanges extends ImmutableList<Range<C>> {
        ...
        ComplementRanges() {
            ...
            this.positiveBoundedBelow = ((Range) r3.ranges.get(0)).hasLowerBound();
            this.positiveBoundedAbove = ((Range) Iterables.getLast(r3.ranges)).hasUpperBound();
            int size = r3.ranges.size() - 1;
    ...
    private ImmutableList<Range<C>> intersectRanges(final Range<C> range) {
        ...
        return new ImmutableList<Range<C>>() { // from class: com.google.common.collect.ImmutableRangeSet.1
            ...
            public Range<C> get(int i4) {
                ...
                if (i4 == 0 || i4 == i3 - 1) {
                    return ((Range) ImmutableRangeSet.this.ranges.get(i4 + i)).intersection(range);
                }
                return (Range) ImmutableRangeSet.this.ranges.get(i4 + i);
            }
        };
    }
