...
public final class MediaType {
    ...
    public static final MediaType ANY_TYPE = createConstant(ProxyConfig.MATCH_ALL_SCHEMES, ProxyConfig.MATCH_ALL_SCHEMES);
    public static final MediaType ANY_TEXT_TYPE = createConstant("text", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final MediaType ANY_IMAGE_TYPE = createConstant("image", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final MediaType ANY_AUDIO_TYPE = createConstant("audio", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final MediaType ANY_VIDEO_TYPE = createConstant("video", ProxyConfig.MATCH_ALL_SCHEMES);
    public static final MediaType ANY_APPLICATION_TYPE = createConstant(MimeTypes.BASE_TYPE_APPLICATION, ProxyConfig.MATCH_ALL_SCHEMES);
    ...
    public boolean hasWildcard() {
        return ProxyConfig.MATCH_ALL_SCHEMES.equals(this.type) || ProxyConfig.MATCH_ALL_SCHEMES.equals(this.subtype);
    }

    public boolean is(MediaType mediaType) {
        return (mediaType.type.equals(ProxyConfig.MATCH_ALL_SCHEMES) || mediaType.type.equals(this.type)) && (mediaType.subtype.equals(ProxyConfig.MATCH_ALL_SCHEMES) || mediaType.subtype.equals(this.subtype)) && this.parameters.entries().containsAll(mediaType.parameters.entries());
    }
    ...
    private static MediaType create(String str, String str2, Multimap<String, String> multimap) {
        ...
        Preconditions.checkArgument(!ProxyConfig.MATCH_ALL_SCHEMES.equals(normalizeToken) || ProxyConfig.MATCH_ALL_SCHEMES.equals(normalizeToken2), "A wildcard type cannot be used with a non-wildcard subtype");
        ImmutableListMultimap.Builder builder = ImmutableListMultimap.builder();
    ...
    public static MediaType parse(String str) {
        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                builder.put((ImmutableListMultimap.Builder) consumeToken3, str2);
            }
        ...
        if (!this.parameters.isEmpty()) {
            ...
            PARAMETER_JOINER.appendTo(sb, Multimaps.transformValues((ListMultimap) this.parameters, (Function) new Function<String, String>() { // from class: com.google.common.net.MediaType.2
                public String apply(String str) {
                    if (MediaType.TOKEN_MATCHER.matchesAllOf(str)) {
                        return str;
                    }
                    return MediaType.escapeAndQuote(str);
                }
            }).entries());
        }
        return sb.toString();
