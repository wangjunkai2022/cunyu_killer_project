    ...
    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        if (methodCall.method.equals("getPlatformVersion")) {
            ...
            try {
                ...
                WatchMan.init(this.context, (String) ((HashMap) methodCall.arguments).get("code"), watchManConf, new InitCallback() { // from class: com.example.plugin_yidun.PluginYidunPlugin.1
