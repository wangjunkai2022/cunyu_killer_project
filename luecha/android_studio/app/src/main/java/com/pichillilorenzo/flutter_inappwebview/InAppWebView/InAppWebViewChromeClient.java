...
public class InAppWebViewChromeClient extends WebChromeClient implements PluginRegistry.ActivityResultListener, GvTFQjxVwkecXbjr.ActivityResultListener {
    ...
    public boolean onJsAlert(final WebView webView, String str, final String str2, final JsResult jsResult) {
        ...
        this.channel.invokeMethod("onJsAlert", hashMap, new MethodChannel.Result() { // from class: com.pichillilorenzo.flutter_inappwebview.InAppWebView.InAppWebViewChromeClient.1
            ...
            public void error(String str3, String str4, Object obj) {
                Log.e("IABWebChromeClient", str3 + ", " + str4);
                jsResult.cancel();
            }
    ...
    public boolean onJsPrompt(final WebView webView, String str, final String str2, final String str3, final JsPromptResult jsPromptResult) {
        ...
        this.channel.invokeMethod("onJsPrompt", hashMap, new MethodChannel.Result() { // from class: com.pichillilorenzo.flutter_inappwebview.InAppWebView.InAppWebViewChromeClient.8
            ...
            public void error(String str4, String str5, Object obj) {
                Log.e("IABWebChromeClient", str4 + ", " + str5);
                jsPromptResult.cancel();
            }
    ...
    public void onProgressChanged(WebView webView, int i) {
        GvTFQjxVwkecXbjr gvTFQjxVwkecXbjr = this.inAppBrowserActivity;
        if (!(gvTFQjxVwkecXbjr == null || gvTFQjxVwkecXbjr.progressBar == null)) {
    ...
    public void onReceivedTitle(WebView webView, String str) {
        ...
        GvTFQjxVwkecXbjr gvTFQjxVwkecXbjr = this.inAppBrowserActivity;
        if (!(gvTFQjxVwkecXbjr == null || gvTFQjxVwkecXbjr.actionBar == null || !this.inAppBrowserActivity.options.toolbarTopFixedTitle.isEmpty())) {
    ...
    private Uri getOutputUri(String str) {
        ...
        try {
            ...
            Log.e("IABWebChromeClient", "Error occurred while creating the File", e);
            e.printStackTrace();
            file = null;
        }
        ...
        return FileProvider.getUriForFile(applicationContext, packageName + ".flutter_inappwebview.fileprovider", file);
    }
