...
public final class InAppWebView extends InputAwareWebView {
    ...
    public Object id;
    public GvTFQjxVwkecXbjr inAppBrowserActivity;
    ...
    public void prepare() {
        ...
        addJavascriptInterface(this.javaScriptBridgeInterface, "flutter_inappwebview");
    ...
    public void setOptions(InAppWebViewOptions inAppWebViewOptions, HashMap<String, Object> hashMap) {
        ...
        if (!(hashMap.get("useShouldInterceptAjaxRequest") == null || this.options.useShouldInterceptAjaxRequest == inAppWebViewOptions.useShouldInterceptAjaxRequest)) {
            ...
            String replace = "window._flutter_inappwebview_useShouldInterceptAjaxRequest = $PLACEHOLDER_VALUE;".replace("$PLACEHOLDER_VALUE", str2);
            if (Build.VERSION.SDK_INT >= 19) {
        ...
        if (!(hashMap.get("useShouldInterceptFetchRequest") == null || this.options.useShouldInterceptFetchRequest == inAppWebViewOptions.useShouldInterceptFetchRequest)) {
            ...
            String replace2 = "window._flutter_inappwebview_useShouldInterceptFetchRequest = $PLACEHOLDER_VALUE;".replace("$PLACEHOLDER_VALUE", str);
            if (Build.VERSION.SDK_INT >= 19) {
        ...
        if (!(hashMap.get("useOnLoadResource") == null || this.options.useOnLoadResource == inAppWebViewOptions.useOnLoadResource)) {
            ...
            String replace3 = "window._flutter_inappwebview_useOnLoadResource = $PLACEHOLDER_VALUE;".replace("$PLACEHOLDER_VALUE", str3);
            if (Build.VERSION.SDK_INT >= 19) {
    ...
    private void sendOnCreateContextMenuEvent() {
        ...
        GvTFQjxVwkecXbjr gvTFQjxVwkecXbjr = this.inAppBrowserActivity;
        if (gvTFQjxVwkecXbjr != null) {
            hashMap2.put("uuid", gvTFQjxVwkecXbjr.uuid);
        }
        hashMap2.put("hitTestResult", hashMap);
