...
public class ChromeCustomTabsOptions implements Options<jNXkEhXpdcfKnlyJ> {
    ...
    public Map<String, Object> getRealOptions(jNXkEhXpdcfKnlyJ jnxkehxpdcfknlyj) {
        Intent intent;
        Map<String, Object> map = toMap();
        if (!(jnxkehxpdcfknlyj == null || (intent = jnxkehxpdcfknlyj.getIntent()) == null)) {
