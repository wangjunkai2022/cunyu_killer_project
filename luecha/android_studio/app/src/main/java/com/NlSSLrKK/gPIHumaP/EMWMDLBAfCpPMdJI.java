...
@Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016¨\u0006\t"}, d2 = {"Lcom/NlSSLrKK/gPIHumaP/EMWMDLBAfCpPMdJI;", "Landroid/content/BroadcastReceiver;", "()V", "onReceive", "", c.R, "Landroid/content/Context;", "intent", "Landroid/content/Intent;", "assets_audio_player_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes2.dex */
public final class EMWMDLBAfCpPMdJI extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String stringExtra = intent.getStringExtra(BWEMZNgHwPapSnPy.EXTRA_PLAYER_ID);
        if (stringExtra != null) {
            String stringExtra2 = intent.getStringExtra(BWEMZNgHwPapSnPy.TRACK_ID) == null ? "" : intent.getStringExtra(BWEMZNgHwPapSnPy.TRACK_ID);
                ...
                switch (action.hashCode()) {
                    case -906021636:
                        if (action.equals(NotificationAction.ACTION_SELECT)) {
                            ...
                            launchIntentForPackage.putExtra(BWEMZNgHwPapSnPy.EXTRA_PLAYER_ID, stringExtra);
                            launchIntentForPackage.putExtra(BWEMZNgHwPapSnPy.TRACK_ID, stringExtra2);
