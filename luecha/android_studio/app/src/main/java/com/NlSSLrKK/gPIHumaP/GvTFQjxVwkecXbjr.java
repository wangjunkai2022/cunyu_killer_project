...
import com.pichillilorenzo.flutter_inappwebview.InAppBrowser.AndroidBug5497Workaround;
import com.pichillilorenzo.flutter_inappwebview.InAppBrowser.DragViewUtil;
...
public class GvTFQjxVwkecXbjr extends AppCompatActivity implements MethodChannel.MethodCallHandler {
    ...
    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        ...
        switch (c) {
            ...
            case 25:
                ...
                if (((str4.hashCode() == 739596306 && str4.equals("InAppBrowserOptions")) ? (char) 0 : 65535) != 0) {
    ...
    private void updateCloseButton() {
        ...
        if (map != null && !map.isEmpty()) {
            ...
            this.ll_close.setOnClickListener(new View.OnClickListener() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    GvTFQjxVwkecXbjr.this.finish();
                }
            });
            if (str9 == "1") {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.4
            ...
            public boolean onQueryTextSubmit(String str) {
                ...
                GvTFQjxVwkecXbjr.this.webView.loadUrl(str);
                GvTFQjxVwkecXbjr.this.searchView.setQuery("", false);
                GvTFQjxVwkecXbjr.this.searchView.setIconified(true);
                return true;
            }
        });
        this.searchView.setOnCloseListener(new SearchView.OnCloseListener() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.5
            @Override // android.widget.SearchView.OnCloseListener
            public boolean onClose() {
                if (GvTFQjxVwkecXbjr.this.searchView.getQuery().toString().isEmpty()) {
                    GvTFQjxVwkecXbjr.this.searchView.setQuery(GvTFQjxVwkecXbjr.this.webView.getUrl(), false);
                }
                return false;
            }
        });
        this.searchView.setOnQueryTextFocusChangeListener(new View.OnFocusChangeListener() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.6
    ...
    public void show() {
        this.isHidden = false;
        Intent intent = new Intent(this, GvTFQjxVwkecXbjr.class);
        intent.setFlags(131072);
        startActivityIfNeeded(intent, 0);
    }
    ...
    public void startSafeBrowsing(final MethodChannel.Result result) {
        if (this.webView == null || Build.VERSION.SDK_INT < 27 || !WebViewFeature.isFeatureSupported("START_SAFE_BROWSING")) {
            ...
            WebViewCompat.startSafeBrowsing(this.webView.getContext(), new ValueCallback<Boolean>() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.7
    ...
    public void saveWebArchive(String str, boolean z, final MethodChannel.Result result) {
        InAppWebView inAppWebView = this.webView;
        if (inAppWebView != null) {
            inAppWebView.saveWebArchive(str, z, new ValueCallback<String>() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.8
    ...
    public void dispose() {
        ...
        if (this.webView != null) {
            ...
            this.webView.setWebViewClient(new WebViewClient() { // from class: com.NlSSLrKK.gPIHumaP.GvTFQjxVwkecXbjr.9
                @Override // android.webkit.WebViewClient
                public void onPageFinished(WebView webView, String str) {
                    GvTFQjxVwkecXbjr.this.webView.dispose();
                    GvTFQjxVwkecXbjr.this.webView.destroy();
                    GvTFQjxVwkecXbjr.this.webView = null;
                }
            });
