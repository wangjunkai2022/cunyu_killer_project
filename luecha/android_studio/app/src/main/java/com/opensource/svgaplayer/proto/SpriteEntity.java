...
public final class SpriteEntity extends Message<SpriteEntity, Builder> {
    ...
    private static final class ProtoAdapter_SpriteEntity extends ProtoAdapter<SpriteEntity> {
        ...
        public com.opensource.svgaplayer.proto.SpriteEntity redact(com.opensource.svgaplayer.proto.SpriteEntity r3) {
            /*
                r2 = this;
                com.opensource.svgaplayer.proto.SpriteEntity$Builder r3 = r3.newBuilder2()
                java.util.List<com.opensource.svgaplayer.proto.FrameEntity> r0 = r3.frames
                com.squareup.wire.ProtoAdapter<com.opensource.svgaplayer.proto.FrameEntity> r1 = com.opensource.svgaplayer.proto.FrameEntity.ADAPTER
                com.squareup.wire.internal.Internal.redactElements(r0, r1)
                r3.clearUnknownFields()
                com.opensource.svgaplayer.proto.SpriteEntity r3 = r3.build()
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.opensource.svgaplayer.proto.SpriteEntity.ProtoAdapter_SpriteEntity.redact(com.opensource.svgaplayer.proto.SpriteEntity):com.opensource.svgaplayer.proto.SpriteEntity");
        }
    }
}
