...
public final class SVGACache {
    ...
    public final void clearCache() {
        if (!isInitialized()) {
            LogUtils.INSTANCE.error("SVGACache", "SVGACache is not init!");
        } else {
    ...
    public final void clearDir$com_opensource_svgaplayer(String str) {
        ...
        try {
            ...
            LogUtils.INSTANCE.error("SVGACache", "Clear svga cache path: " + str + " fail", e);
        }
    }
