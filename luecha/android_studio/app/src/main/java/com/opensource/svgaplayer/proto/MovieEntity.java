...
public final class MovieEntity extends Message<MovieEntity, Builder> {
    ...
    private static final class ProtoAdapter_MovieEntity extends ProtoAdapter<MovieEntity> {
        ...
        public com.opensource.svgaplayer.proto.MovieEntity redact(com.opensource.svgaplayer.proto.MovieEntity r3) {
            /*
                r2 = this;
                com.opensource.svgaplayer.proto.MovieEntity$Builder r3 = r3.newBuilder2()
                com.opensource.svgaplayer.proto.MovieParams r0 = r3.params
                if (r0 == 0) goto L_0x0014
                com.squareup.wire.ProtoAdapter<com.opensource.svgaplayer.proto.MovieParams> r0 = com.opensource.svgaplayer.proto.MovieParams.ADAPTER
                com.opensource.svgaplayer.proto.MovieParams r1 = r3.params
                java.lang.Object r0 = r0.redact(r1)
                com.opensource.svgaplayer.proto.MovieParams r0 = (com.opensource.svgaplayer.proto.MovieParams) r0
                r3.params = r0
            L_0x0014:
                java.util.List<com.opensource.svgaplayer.proto.SpriteEntity> r0 = r3.sprites
                com.squareup.wire.ProtoAdapter<com.opensource.svgaplayer.proto.SpriteEntity> r1 = com.opensource.svgaplayer.proto.SpriteEntity.ADAPTER
                com.squareup.wire.internal.Internal.redactElements(r0, r1)
                java.util.List<com.opensource.svgaplayer.proto.AudioEntity> r0 = r3.audios
                com.squareup.wire.ProtoAdapter<com.opensource.svgaplayer.proto.AudioEntity> r1 = com.opensource.svgaplayer.proto.AudioEntity.ADAPTER
                com.squareup.wire.internal.Internal.redactElements(r0, r1)
                r3.clearUnknownFields()
                com.opensource.svgaplayer.proto.MovieEntity r3 = r3.build()
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.opensource.svgaplayer.proto.MovieEntity.ProtoAdapter_MovieEntity.redact(com.opensource.svgaplayer.proto.MovieEntity):com.opensource.svgaplayer.proto.MovieEntity");
        }
    }
}
