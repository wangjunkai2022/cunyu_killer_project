        ...
        try {
            ...
            if (th instanceof PlayerFinder.NoPlayerFoundException) {
                ...
                if (noPlayerFoundException.getWhy() != null) {
                    this.$result.error("OPEN", noPlayerFoundException.getWhy().getMessage(), MapsKt.mapOf(TuplesKt.to("type", noPlayerFoundException.getWhy().getType()), TuplesKt.to("message", noPlayerFoundException.getWhy().getMessage())));
                }
            }
