...
public class c {
                ...
                public void onImprintValueChanged(String str, String str2) {
                    ...
                    if (FieldManager.allow(com.umeng.commonsdk.utils.b.E)) {
                        ...
                        if (!UMWorkDispatch.eventHasExist()) {
                            UMWorkDispatch.sendEventEx(c.this.c, n.a.C, CoreProtocol.getInstance(c.this.c), null, 0);
                        }
                    }
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: SSATransform
        jadx.core.utils.exceptions.JadxRuntimeException: Not initialized variable reg: 6, insn: 0x0183: IF  (r6 I:??[int, boolean, OBJECT, ARRAY, byte, short, char]) == (0 ??[int, boolean, OBJECT, ARRAY, byte, short, char])  -> B:86:0x018f, block:B:82:0x0183
