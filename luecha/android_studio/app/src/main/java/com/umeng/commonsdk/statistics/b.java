    ...
    private static JSONObject b(Context context) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(i)) {
                ...
                jSONObject2.put(ai.v, DeviceConfig.getDeviceIdUmengMD5(context));
                ...
                jSONObject2.put(ai.o, DeviceConfig.getPackageName(context));
                ...
                jSONObject2.put(ai.J, Build.DEVICE);
                jSONObject2.put("os_version", Build.VERSION.RELEASE);
                jSONObject2.put(ai.x, "Android");
                int[] resolutionArray = DeviceConfig.getResolutionArray(context);
                if (resolutionArray != null) {
                    jSONObject2.put(ai.z, resolutionArray[1] + ProxyConfig.MATCH_ALL_SCHEMES + resolutionArray[0]);
                }
                ...
                jSONObject2.put(ai.N, localeInfo[1]);
                jSONObject2.put(ai.P, DeviceConfig.getNetworkOperatorName(context));
                jSONObject2.put(ai.s, DeviceConfig.getAppName(context));
