    ...
    public static class b extends AsyncTask<byte[], Void, c> {
        ...
        public c doInBackground(byte[]... bArr) {
            ...
            try {
                ...
                cVar.b = e.toString();
                cVar.a = i;
                TXCLog.i("TXHttpRequest", "doInBackground Exception e=" + cVar.a + str + cVar.b);
            }
            ...
            str = cVar.b;
            sb.append(str);
            TXCLog.i("TXHttpRequest", sb.toString());
            return cVar;
        }
            ...
            if (tXHttpRequest != null && tXHttpRequest.mNativeHttps != 0) {
                ...
                if (handler != null) {
                    handler.post(new Runnable() { // from class: com.tencent.liteav.basic.util.TXHttpRequest.b.1
                        @Override // java.lang.Runnable
                        public void run() {
                            TXCLog.i("TXHttpRequest", "TXPostRequest->recvMsg: " + cVar.a + "|" + cVar.b);
