...
public class TXCAudioNativeInterface {
    ...
    public TXCAudioNativeInterface(Context context) {
        ...
        TXCLog.i("AudioNativeInterface", "AudioDeviceInterface SDK_INT: %d, MANUFACTURE: %s, MODEL: %s", Integer.valueOf(TXCBuild.VersionInt()), TXCBuild.Manufacturer(), TXCBuild.Model());
    }

    public void initAudioRouteManager() {
        if (this.mContext != null) {
            TXCLog.i("AudioNativeInterface", "initAudioManager, TXCAudioSession create");
    ...
    public int startService(String str) {
        TXCLog.i("AudioNativeInterface", "startService: " + this.mAudioSession + " deviceConfig:" + str);
    ...
    public void notifyAudioIOSceneChanged(int i, int i2) {
        ...
        TXCLog.i("AudioNativeInterface", "notify audio io scene changed, %s -> %s", nativeValueToAudioIOScene, nativeValueToAudioIOScene2);
        ...
        if (nativeValueToAudioIOScene2 != a.EnumC0021a.STOPPED) {
            ...
            if (audioManager != null) {
                ...
                if (audioManager.isMicrophoneMute()) {
                    ...
                    TXCLog.i("AudioNativeInterface", "setMicrophoneMute false when ioscene changed");
                }
            }
    ...
    public int setAudioOutputMode(int i) {
        f fVar;
        TXCLog.w("AudioNativeInterface", "TXCAudioSession SetAudioOutputMode: " + i);
        if (i == 0) {
    ...
    public int stopService() {
        TXCLog.i("AudioNativeInterface", "stopService: " + this.mAudioSession);
        f fVar = this.mAudioSession;
        if (fVar != null) {
            return fVar.c();
        }
    ...
    public void uninitAudioRouteManager() {
        if (this.mContext != null) {
            TXCLog.w("AudioNativeInterface", "uninitTXCAudioManager , stopService");
            f fVar = this.mAudioSession;
            if (fVar != null) {
                fVar.c();
        ...
        TXCLog.w("AudioNativeInterface", "uninitTXCAudioManager , context null");
    }
    ...
    private void updateVolumeTypeForMedia() {
        ...
        if (!(audioManager == null || audioManager.getMode() == 0)) {
            try {
                ...
                TXCLog.e("AudioNativeInterface", "updateVolumeTypeForMedia failed. " + e);
            }
        }
        this.mAudioSession.d();
        LogTraceExit();
        ...
        if (getAudioManager() != null) {
            ...
            while (true) {
                ...
                if (i > 0 && this.mAudioManager.getMode() == 2) {
                    TXCLog.e("AudioNativeInterface", "waiting.  mode:" + this.mAudioManager.getMode());
                    try {
                        Thread.sleep(500);
    ...
    public static void LogTraceEntry(String str) {
        TXCLog.i("AudioNativeInterface", getTraceInfo() + " entry:" + str);
    }

    public static void LogTraceExit() {
        TXCLog.i("AudioNativeInterface", getTraceInfo() + " exit");
    }
    ...
    public void notifyPlayoutDeviceChanged(String str) {
        int i;
        TXCLog.i("AudioNativeInterface", "device: " + str);
