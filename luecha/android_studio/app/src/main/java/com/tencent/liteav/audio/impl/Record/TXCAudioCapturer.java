...
public class TXCAudioCapturer {
    ...
    public boolean startRecord(int i, int i2, int i3, int i4) {
        ...
        if (minBufferSize <= 0) {
            TXCLog.e("TXCAudioCapturer", "AudioRecord.getMinBufferSize returns invalid value: " + minBufferSize);
            return false;
        }
    ...
    private static AudioRecord createStartedAudioRecord(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            TXCLog.w("TXCAudioCapturer", "create AudioRecord failed. source: %s, samplerate: %d, channelConfig: %d, bufferSize: %d", audioSourceToText(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4));
    ...
    private static void tearDownAudioRecord(AudioRecord audioRecord) {
        if (audioRecord != null) {
            try {
                ...
                TXCLog.e("TXCAudioCapturer", "stop AudioRecord failed.", e);
            }
        }
    }
    ...
    public int read(ByteBuffer byteBuffer, int i) {
        ...
        TXCLog.e("TXCAudioCapturer", "read failed, %d", Integer.valueOf(read));
        return -1;
    }
