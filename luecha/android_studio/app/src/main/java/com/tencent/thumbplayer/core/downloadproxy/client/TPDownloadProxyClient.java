...
public class TPDownloadProxyClient implements ITPDownloadProxy {
    ...
    public int init(Context context, TPDLProxyInitParam tPDLProxyInitParam) {
        ...
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "init failed, error:" + th.toString());
            return -2;
        }
    }
    ...
    public int startPlay(String str, TPDownloadParam tPDownloadParam, final ITPPlayListener iTPPlayListener) {
        if (!(this.downloadProxyAidl == null || tPDownloadParam == null)) {
            ...
            try {
                ...
                TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "startPlay failed, error:" + th.toString());
            }
        }
        return -1;
    }
    ...
    public int startClipPlay(String str, int i, final ITPPlayListener iTPPlayListener) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "startClipPlay failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public boolean setClipInfo(int i, int i2, String str, TPDownloadParam tPDownloadParam) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "setClipInfo failed, error:" + th.toString());
            return false;
        }
    }
    ...
    public String getPlayUrl(int i, int i2) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "getPlayUrl failed, error:" + th.toString());
            return null;
        }
    }
    ...
    public String getClipPlayUrl(int i, int i2, int i3) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "getClipPlayUrl failed, error:" + th.toString());
            return null;
        }
    }
    ...
    public String getPlayErrorCodeStr(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "getPlayErrorCodeStr failed, error:" + th.toString());
            return null;
        }
    }
    ...
    public void stopPlay(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "stopPlay failed, error:" + th.toString());
        }
    }
    ...
    public int pauseDownload(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "pauseDownload failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public int resumeDownload(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "resumeDownload failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public int startPreload(String str, TPDownloadParam tPDownloadParam, final ITPPreLoadListener iTPPreLoadListener) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "startPreload failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public int startClipPreload(String str, int i, final ITPPreLoadListener iTPPreLoadListener) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "startClipPreload failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public void stopPreload(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "stopPreload failed, error:" + th.toString());
        }
    }
    ...
    public void startTask(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "startTask failed, error:" + th.toString());
        }
    }
    ...
    public void setMaxStorageSizeMB(long j) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "setMaxStorageSizeMB failed, error:" + th.toString());
        }
    }
    ...
    public void setUserData(String str, Object obj) {
        ...
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "setUserData failed, error:" + th.toString());
        }
    }
    ...
    public String getNativeInfo(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "getNativeInfo failed, error:" + th.toString());
            return null;
        }
    }
    ...
    public int checkResourceStatus(String str, String str2, int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "checkResourceStatus failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public long getResourceSize(String str, String str2) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "getResourceSize failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public void pushEvent(int i) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "pushEvent failed, error:" + th.toString());
        }
    }
    ...
    public void setPlayState(int i, int i2) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "setPlayState failed, error:" + th.toString());
        }
    }
    ...
    public void updateTaskInfo(int i, String str, Object obj) {
        ...
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyClient", 0, "tpdlnative", "updateTaskInfo failed, error:" + th.toString());
        }
    }
}
