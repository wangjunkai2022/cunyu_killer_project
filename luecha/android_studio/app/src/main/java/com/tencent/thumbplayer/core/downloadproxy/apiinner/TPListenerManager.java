    ...
    public synchronized void handleCallbackMessage(final int i, final int i2, final Object obj, final Object obj2, final Object obj3, final Object obj4, final Object obj5) {
        if (2008 == i) {
            if (this.mNetwork == null) {
                TPDLProxyLog.e("TPListenerManager", 0, "tpdlnative", "cellular_network, network is null");
                return;
            }
            ...
            TPDLProxyLog.i("TPListenerManager", 0, "tpdlnative", "cellular_network, bind begin, sock fd: " + parseInt);
            if (Build.VERSION.SDK_INT >= 23) {
                this.mNetwork.bindSocket(fileDescriptor);
                TPDLProxyLog.i("TPListenerManager", 0, "tpdlnative", "cellular_network, bind socket success, sock fd: " + parseInt);
            }
            TPDLProxyLog.i("TPListenerManager", 0, "tpdlnative", "cellular_network, sock call back end, sock fd: " + parseInt + ", str_sock: " + byteArrayToString);
    ...
    private void dispatchPlayMessage(ITPPlayListener iTPPlayListener, int i, int i2, Object obj, Object obj2, Object obj3, Object obj4, Object obj5) {
        ...
        if (iTPPlayListener != null) {
            if (i == 101) {
                ...
                TPDLProxyLog.i("TPListenerManager", 0, "tpdlnative", "MSG_MULTI_NETWORK: " + byteArrayToString2);
            } else if (i == 3001) {
                ...
                TVKThreadUtil.getScheduledExecutorServiceInstance().execute(new Runnable() { // from class: com.tencent.thumbplayer.core.downloadproxy.apiinner.TPListenerManager.3
                    @Override // java.lang.Runnable
                    public void run() {
                        TPDownloadProxyNative.getInstance().setUserData("lose_package_check_info", TPDLProxyUtils.losePackageCheck(objectToInt2));
                    }
                });
            }
        }
