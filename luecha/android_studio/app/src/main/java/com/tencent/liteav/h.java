...
public class h extends j implements a.AbstractC0026a, f {
    ...
    private e t = new e() { // from class: com.tencent.liteav.h.1
        ...
        public void a(int i, Bundle bundle) {
            ...
            if (i == -2301) {
                ...
                TXCLog.i("TXVodPlayer", "vod onPlayEvent EVT_VOD_PLAY_PREPARED");
                i3 = 2013;
            } else if (i != 2014) {
                switch (i) {
                    case -2305:
                    ...
                    default:
                        ...
                        switch (i) {
                            case 2003:
                                TXCLog.i("TXVodPlayer", "vod onPlayEvent EVT_RENDER_FIRST_I_FRAME");
                                h.this.h.h();
                                if (!h.this.i) {
                                    h.this.i = true;
                                    i2 = 2003;
                                    ...
                                    bundle3.putLong("EVT_UTC_TIME", TXCTimeUtil.getUtcTimeTick());
                                ...
                                break;
                            case 2004:
                                TXCLog.i("TXVodPlayer", "vod onPlayEvent PLAY_EVT_PLAY_BEGIN");
                                i3 = 2004;
                                break;
                            case 2005:
                                i3 = 2005;
                                h.this.h.a(bundle.getInt("EVT_PLAY_DURATION", 0), bundle.getInt("EVT_PLAY_PROGRESS", 0));
                                break;
                            case 2006:
                                h.this.h.c();
                                i2 = 2006;
                            ...
                            default:
                                switch (i) {
                                    ...
                                    case 2019:
                                        return;
                                    default:
                                        TXCLog.d("TXVodPlayer", "miss match event " + i);
                                        return;
                                }
                        }
                }
        ...
        public void a(Bundle bundle) {
            ...
            bundle2.putInt("VIDEO_WIDTH", h.this.f.getVideoWidth());
            bundle2.putInt("VIDEO_HEIGHT", h.this.f.getVideoHeight());
            bundle2.putString("SERVER_IP", h.this.f.getServerIp());
    ...
    public int a(String str, int i, com.tencent.liteav.basic.b.a aVar) {
        ...
        TXCLog.d("TXVodPlayer", "startPlay " + c);
    ...
    private void h(boolean z) {
        ...
        try {
            ...
            TXCLog.e("TXVodPlayer", "setTRTCCustomVideoCapture error ", e);
        }
    }
    ...
    public void onTextureProcess(int i, int i2, int i3, int i4) {
        try {
            ...
            TXCLog.e("TXVodPlayer", "get enableCustomVideoCapture method error ", e);
        }
    }
    ...
    private static class a {
        ...
        public a(Object obj) {
            try {
                ...
                TXCLog.e("TXVodPlayer", "init TRTCCloudClassInvokeWrapper error ", e);
            }
        }
        ...
        public void a(Object obj, com.tencent.liteav.renderer.a aVar, int i, int i2, int i3) {
            try {
                ...
                TXCLog.e("TXVodPlayer", "sendCustomVideoData method error ", e);
            }
        }
    }
