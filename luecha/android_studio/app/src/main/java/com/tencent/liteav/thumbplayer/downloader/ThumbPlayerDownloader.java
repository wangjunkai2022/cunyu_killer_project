...
public class ThumbPlayerDownloader extends a {
    ...
    private ITPDownloadProxy mTpDownloadProxy = TPDownloadProxyFactory.getTPDownloadProxy(2330303);
    ...
    private ThumbPlayerDownloader(Context context) {
        if (context != null) {
            ...
            this.mTpDownloadProxy.init(context, new TPDLProxyInitParam(2330303, "1.0.0", "liteav_tbplayer_android_" + context.getPackageName(), this.mDownloadPath));
        }
    }
