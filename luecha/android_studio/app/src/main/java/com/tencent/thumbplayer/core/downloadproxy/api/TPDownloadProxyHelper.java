...
public class TPDownloadProxyHelper {
    ...
    public static String getHLSOfflineExttag(String str, String str2, int i, long j) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyHelper", 0, "tpdlnative", "get exttag failed, error:" + th.toString());
            return "";
        }
    }
    ...
    public static long verifyOfflineCacheSync(String str, int i, String str2, String str3) {
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyHelper", 0, "tpdlnative", "verify offline cache failed, error:" + th.toString());
            return -1;
        }
    }
    ...
    public static void setUserData(String str, Object obj) {
        if (TPDownloadProxyNative.getInstance().isNativeLoaded()) {
            try {
                ...
                TPDLProxyLog.e("TPDownloadProxyHelper", 0, "tpdlnative", "setUserData failed, error:" + th.toString());
            }
        }
    }
    ...
    public static String getNativeInfo(int i) {
        ...
        try {
            ...
            TPDLProxyLog.e("TPDownloadProxyHelper", 0, "tpdlnative", "getNativeInfo failed, error:" + th.toString());
            return null;
        }
    }
}
