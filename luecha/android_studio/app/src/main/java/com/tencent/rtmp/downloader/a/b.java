...
public class b extends TXVodDownloadManager {
        ...
        public void c(a aVar, com.tencent.liteav.txcplayer.b.b bVar) {
            ...
            if (a != null) {
                ...
                if (b.this.d(a.getPlayPath())) {
                    ...
                    b.this.d.onDownloadError(a, -5003, "The file has been deleted");
                }
            }
        }
        ...
        public void a(a aVar, com.tencent.liteav.txcplayer.b.b bVar, int i, String str) {
            ...
            if (a != null) {
                ...
                if (a.getDownloadState() == 2) {
                    ...
                    b.this.d.onDownloadError(a, -5006, str);
                } else if (i == 14020003) {
                    b.this.d.onDownloadError(a, -5008, str);
                } else {
                    b.this.d.onDownloadError(a, -5005, str);
                }
            }
        }
        ...
        iVar.a(new j() { // from class: com.tencent.rtmp.downloader.a.b.1
            ...
            public void onNetSuccess(i iVar2) {
                ...
                if (nVar == null) {
                    ...
                    if (b.this.d != null) {
                        b.this.d.onDownloadError(cVar, -5003, "No such resolution");
                        return;
                    }
                    return;
                }
            ...
            public void onNetFailed(i iVar2, String str, int i) {
                ...
                if (b.this.d != null) {
                    b.this.d.onDownloadError(cVar, -5001, str);
                }
            }
        });
    ...
    public c b(TXVodDownloadDataSource tXVodDownloadDataSource) {
        ...
        new g(new com.tencent.rtmp.b(aVar.getAppId(), aVar.getFileId(), aVar.getPSign())).a(new g.a() { // from class: com.tencent.rtmp.downloader.a.b.2
            @Override // com.tencent.liteav.network.g.a
            public void a(g gVar, com.tencent.rtmp.b bVar) {
                TXLog.i("TXVodDownloadManagerEx", "onSuccess: protocol params = " + bVar.toString());
                if (cVar.getDownloadState() == 2) {
                    synchronized (b.this.c) {
                        b.this.c.remove(cVar);
                    }
                ...
                if (!TextUtils.isEmpty(bVar.c()) && !TextUtils.isEmpty(gVar.h()) && !TextUtils.isEmpty(gVar.i())) {
        ...
        if (gVar != null && cVar.getDataSource() != null) {
            ...
            com.tencent.liteav.network.c.a().a(a, new c.b() { // from class: com.tencent.rtmp.downloader.a.b.3
                ...
                public void a() {
                    ...
                    if (b.this.d != null) {
                        b.this.d.onDownloadError(cVar, -5001, "get substream infos failure");
                    }
                }
            });
        }
    ...
    public void a(c cVar) {
        ...
        if (url != null) {
            if (Uri.parse(url).getPath().endsWith(".m3u8")) {
                cVar.a(this.b.makePlayPath(url));
                ...
                if (!(cVar.getDataSource() == null || cVar.getDataSource().getToken() == null)) {
                    String[] split = url.split("/");
                    if (split.length > 0) {
                        int lastIndexOf = url.lastIndexOf(split[split.length - 1]);
                        url = url.substring(0, lastIndexOf) + "voddrm.token." + cVar.getDataSource().getToken() + "." + url.substring(lastIndexOf);
                    }
                }
            ...
            if (iTXVodDownloadListener3 != null) {
                iTXVodDownloadListener3.onDownloadError(cVar, -5004, "No support format");
            }
        }
    }
    ...
    private c e(String str) {
        ...
        obtain.recycle();
        if (!(createFromParcel == null || createFromParcel.getDataSource() == null)) {
            a aVar = (a) createFromParcel.getDataSource();
            String overlayKey = aVar.getOverlayKey();
            String overlayIv = aVar.getOverlayIv();
            if (!TextUtils.isEmpty(overlayKey) && !TextUtils.isEmpty(overlayIv)) {
                String a = TXCHLSEncoder.a(aVar.getAppId(), aVar.getUserName(), aVar.getFileId(), aVar.getQuality());
                aVar.a(TXCHLSEncoder.b(a, overlayKey));
                aVar.b(TXCHLSEncoder.b(a, overlayIv));
            }
        }
