...
public interface ITPPlayListenerAidl extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ITPPlayListenerAidl {
        ...
        public static ITPPlayListenerAidl asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.tencent.thumbplayer.core.downloadproxy.aidl.ITPPlayListenerAidl");
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i != 1598968902) {
                switch (i) {
                    case 1:
                        parcel.enforceInterface("com.tencent.thumbplayer.core.downloadproxy.aidl.ITPPlayListenerAidl");
                ...
                parcel2.writeString("com.tencent.thumbplayer.core.downloadproxy.aidl.ITPPlayListenerAidl");
                return true;
            }
        }
         ...
         */
        /* loaded from: classes5.dex */
        private static class Proxy implements ITPPlayListenerAidl {
            ...
            public void onDownloadProgressUpdate(int i, int i2, long j, long j2, String str) throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.tencent.thumbplayer.core.downloadproxy.aidl.ITPPlayListenerAidl");
                    obtain.writeInt(i);
                    obtain.writeInt(i2);
                    obtain.writeLong(j);
                    obtain.writeLong(j2);
