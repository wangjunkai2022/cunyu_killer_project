...
public class TPCGIRequester {
    ...
    public void addNotifyReqQueue(TPRequestItem tPRequestItem) {
        try {
            ...
            TPDLProxyLog.e("TPCGIRequester", 0, "tpdlnative", "RequestQueue add failed:" + th.toString());
        }
    }
            ...
            public void run() {
                while (true) {
                    try {
                        ...
                        TPDLProxyLog.e("TPCGIRequester", 0, "tpdlnative", "request queue take failed: " + th.toString());
                    }
                }
            }
        });
    ...
    public void addRetryRequestItem(TPRequestItem tPRequestItem) {
        try {
            ...
            TPDLProxyLog.e("TPCGIRequester", 0, "tpdlnative", "retry queue add failed" + th.toString());
        }
    }
}
