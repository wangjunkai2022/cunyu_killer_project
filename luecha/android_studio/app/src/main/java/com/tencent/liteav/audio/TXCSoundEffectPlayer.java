...
public class TXCSoundEffectPlayer implements TXAudioEffectManager.TXMusicPlayObserver {
    ...
    public boolean playEffectWithId(int i, String str, boolean z, int i2) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "playEffectWithId -> effect id = " + i + ", path = " + str + ", loop = " + i2);
        ...
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "playEffectWithId ->effect id = " + i + ", startPlayMusic result = " + startPlayMusic);
        return startPlayMusic;
    }

    public void stopEffectWithId(int i) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "stopEffectWithId -> effect id = " + i);
    ...
    public void setEffectsVolume(float f) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "setEffectsVolume -> volume = " + f);
        for (Integer num : this.mShortEffectorIDList) {
    ...
    public void setVolumeOfEffect(int i, float f) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "setVolumeOfEffect -> effect id = " + i + ", volume = " + f);
        TXAudioEffectManagerImpl.getCacheInstance().setMusicVolume(i, (int) (f * 100.0f));
    }

    public void pauseEffectWithId(int i) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "pauseEffectWithId -> effect id = " + i);
        TXAudioEffectManagerImpl.getCacheInstance().pausePlayMusic(i);
    }

    public void resumeEffectWithId(int i) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "resumeEffectWithId -> effect id = " + i);
    ...
    public void onStart(int i, int i2) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "onStart -> effect id = " + i + ", errCode = " + i2);
    ...
    public void onComplete(int i, int i2) {
        TXCLog.i("AudioCenter:TXCSoundEffectPlayer", "onMusicPlayFinish -> effect id = " + i);
        WeakReference<a> weakReference = mWeakSoundEffectListener;
        if (weakReference != null && weakReference.get() != null) {
    ...
    public void clearCache() {
        if (TXCCommonUtil.getAppContext() != null) {
            try {
                ...
                TXCLog.w("AudioCenter:TXCSoundEffectPlayer", "clearCache error " + e.toString());
            }
        }
    }
        ...
        if (!TextUtils.isEmpty(str) && TXCCommonUtil.getAppContext() != null) {
            ...
            try {
                try {
                    ...
                    TXCLog.e("AudioCenter:TXCSoundEffectPlayer", "playAudioEffect openFd error " + e.toString());
                    j = 0;
                }
                ...
                TXCLog.e("AudioCenter:TXCSoundEffectPlayer", "playAudioEffect error " + e2.toString());
            }
        }
        return str;
    }
