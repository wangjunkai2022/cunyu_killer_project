...
public class TXCAudioEngine implements b, a {
    ...
    public static synchronized void UninitInstance() {
        synchronized (TXCAudioEngine.class) {
            TXCLog.i("AudioEngine :TXCAudioEngine_java", "uninit audio engine instance");
    ...
    public int startLocalAudio(int i, boolean z) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "startLocalAudio audioFormat:" + i);
    ...
    public int pauseAudioCapture(boolean z) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "pauseAudioCapture: " + z);
    ...
    public boolean muteLocalAudio(boolean z) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setRecordMute: " + z);
    ...
    public boolean setReverbParamType(int i, float f) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setReverbParamType: reverbParamType =" + i + " value = " + f);
        TXCAudioEngineJNI.nativeSetRecordReverbParam(i, f);
        return true;
    }

    public boolean setVoicePitch(double d) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setVoicePitch: " + d);
    ...
    public void enableSoftAEC(boolean z, int i) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "enableSoftAEC: enable = " + z + " level = " + i);
        if (!z) {
            i = 0;
        }
    ...
    public void enableSoftANS(boolean z, int i) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "enableSoftANS: enable = " + z + " level = " + i);
        if (!z) {
            i = 0;
        }
    ...
    public void enableSoftAGC(boolean z, int i) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "enableSoftAGC: enable = " + z + " level = " + i);
        if (!z) {
            i = 0;
        }
    ...
    public boolean enableCaptureEOSMode(boolean z) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "enableEosMode " + z);
    ...
    public static void onAudioJitterBufferNotify(String str, int i, String str2) {
        ...
        if (cVar != null) {
            TXCLog.i("AudioEngine :TXCAudioEngine_java", "onAudioJitterBufferNotify  cur state " + i);
            cVar.a(str, i, str2);
        }
    }
    ...
    private void handleAudioEvent(String str, int i, String str2, String str3) {
        if (i == 10055) {
            ...
            TXCAudioSettings.getInstance().setLong("timestamp_rollback_to_stable_samplerate", 0);
    ...
    public void setCaptureDataCallbackFormat(int i, int i2, int i3) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setCaptureDataCallbackFormat: sampleRate-" + i + " channels-" + i2 + " length-" + i3);
    ...
    public void setLocalProcessedDataCallbackFormat(int i, int i2, int i3) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setLocalProcessedDataCallbackFormat: sampleRate-" + i + " channels-" + i2 + " length-" + i3);
    ...
    public void setPlayoutDataCallbackFormat(int i, int i2, int i3) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setPlayoutDataCallbackFormat: sampleRate-" + i + " channels-" + i2 + " length-" + i3);
    ...
    public void setRemoteStreamDataCallbackFormat(String str, int i, int i2, int i3) {
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "setRemoteStreamDataCallbackFormat: id-" + str + " sampleRate-" + i + " channels-" + i2 + " length-" + i3);
    ...
    public static String buildTRAEConfig(Context context, Boolean bool, boolean z, long j) {
        ...
        boolean z2 = System.currentTimeMillis() - TXCAudioSettings.getInstance().getLong("timestamp_rollback_to_stable_samplerate", 0) < j;
        TXCLog.i("AudioEngine :TXCAudioEngine_java", "low latency samplerate, enable: %b, isBlocked: %b, blockTime: %d", Boolean.valueOf(z), Boolean.valueOf(z2), Long.valueOf(j));
    ...
    private static int getLowLatencySampleRate(Context context) {
        ...
        try {
            ...
            TXCLog.e("AudioEngine :TXCAudioEngine_java", "can't parse low latency samplerate", e);
            return -1;
        }
    }
    ...
    public void onAudioKitInitFinished(TXSystemAudioKit tXSystemAudioKit, boolean z) {
        if (this.mAudioKit == tXSystemAudioKit) {
            TXCLog.i("AudioEngine :TXCAudioEngine_java", "system audio kit init finished, ret: %b.", Boolean.valueOf(z));
            if (!z) {
                TXCAudioEngineJNI.nativeSetSystemEarMonitoring(null);
            }
        }
    ...
    public void onEarMonitoringInitialized(TXSystemAudioKit tXSystemAudioKit, boolean z) {
        if (this.mAudioKit == tXSystemAudioKit) {
            TXCLog.i("AudioEngine :TXCAudioEngine_java", "onEarMonitoringInitialized result: %b", Boolean.valueOf(z));
            if (z) {
    ...
    private static String getAudioResourceDirectory(Context context) {
        ...
        if (new File(str).mkdirs()) {
            TXCLog.e("AudioEngine :TXCAudioEngine_java", "create audio resource directory failed.");
        }
        return str;
    }
}
