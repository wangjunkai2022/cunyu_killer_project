...
public class TPPlayerMgr {
    ...
    public static boolean getPropertyBoolean(String str) {
        if (TextUtils.equals("PROPERTY_MediaDrmReuse", str)) {
    ...
    public static int getPropertyInteger(String str) {
        if (TextUtils.equals("PROPERTY_VideoMediaCodecCoexistMaxCnt", str)) {
    ...
    private static void initAsyncWithoutWait() {
        o.a().d().execute(new Runnable() { // from class: com.tencent.thumbplayer.api.TPPlayerMgr.3
            ...
            public void run() {
                ...
                TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithoutWait  nativeKeyMap init, times: " + dVar.c());
                TPThumbplayerCapabilityHelper.init(TPPlayerMgr.mAppContext, true);
                TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithoutWait  TPThumbplayerCapabilityHelper init, times: " + dVar.e());
                i.a().a(TPPlayerMgr.mAppContext);
                new c().a();
                try {
                    TPNativePlayer.playerCoreNativeSetup(TPPlayerMgr.mAppContext);
                } catch (UnsupportedOperationException e) {
                    TPLogUtil.e("TPThumbPlayer[TPPlayerMgr.java]", e);
                }
                TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithoutWait all times: " + dVar.d());
            }
        });
    }
    ...
    public static void initInAsyncThread() {
        ...
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithWait  TPBeaconReportWrapper init, times: " + dVar.e());
        a.a(mAppContext);
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithWait  TPDrmCapability init, times: " + dVar.e());
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initAsyncWithWait all times: " + dVar.d());
    }
        ...
        if (mIsInit) {
            ...
            try {
                if (initAsyncWithWait.get().booleanValue()) {
                    TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, TPPlayer  wait initSync finish, times: " + dVar.c());
                }
                ...
                sb.append(str3);
                sb.append(dVar.c());
                TPLogUtil.e("TPThumbPlayer[TPPlayerMgr.java]", sb.toString());
                str2 = "Init SDK, TPPlayer all times: " + dVar.d();
                TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", str2);
    ...
    private static void initSync() {
        ...
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, initSync so load times: " + dVar.d());
    }
    ...
    private static void preInitSync(Context context, String str, int i) {
        ...
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "Init SDK, preInitSync all times: " + dVar.d());
    }

    public static void setDataReportEnable(boolean z) {
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "set data report enable : " + z);
            ...
            TPNativeLibraryLoader.setLibLoader(new ITPNativeLibraryExternalLoader() { // from class: com.tencent.thumbplayer.api.TPPlayerMgr.4
                ...
                public boolean loadLib(String str, String str2) {
                    ...
                    try {
                        ...
                        TPLogUtil.e("TPThumbPlayer[TPPlayerMgr.java]", th);
                        return false;
                    }
                }
            });
    ...
    public static void setProxyMaxStorageSizeMB(long j) {
        TPLogUtil.i("TPThumbPlayer[TPPlayerMgr.java]", "setProxyMaxStorageSize: " + j + " MB.");
