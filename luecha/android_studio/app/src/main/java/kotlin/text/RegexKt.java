...
public final class RegexKt {
    ...
    public static final /* synthetic */ <T extends Enum<T> & FlagEnum> Set<T> fromInt(int i) {
        ...
        CollectionsKt.retainAll(allOf, new Function1<T, Boolean>(i) { // from class: kotlin.text.RegexKt$fromInt$$inlined$apply$lambda$1
