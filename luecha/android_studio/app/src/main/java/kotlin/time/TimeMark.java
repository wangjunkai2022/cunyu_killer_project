...
public abstract class TimeMark {
    ...
    public TimeMark m1412minusLRDsOJo(long j) {
        return mo1320plusLRDsOJo(Duration.m1381unaryMinusUwyO8pc(j));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1361isNegativeimpl(mo1319elapsedNowUwyO8pc());
    }
