...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1321getAdjustmentUwyO8pc() {
    ...
    public long mo1319elapsedNowUwyO8pc() {
        return Duration.m1363minusLRDsOJo(this.mark.mo1319elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1320plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1364plusLRDsOJo(this.adjustment, j));
    }
}
