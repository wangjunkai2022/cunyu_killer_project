...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1413copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1415copyRFiDyg4(obj, j);
    }
    ...
    public final long m1414component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1415copyRFiDyg4(T t, long j) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1378toStringimpl(this.duration) + ")";
    }
    ...
    public final long m1416getDurationUwyO8pc() {
        return this.duration;
    }
