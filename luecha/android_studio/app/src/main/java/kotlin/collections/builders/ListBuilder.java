...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, KMutableList {
    ...
    public <T> T[] toArray(T[] tArr) {
        ...
        if (length < i) {
            ...
            Intrinsics.checkNotNullExpressionValue(tArr2, "java.util.Arrays.copyOfR…h, destination.javaClass)");
            return tArr2;
        }
        E[] eArr2 = this.array;
