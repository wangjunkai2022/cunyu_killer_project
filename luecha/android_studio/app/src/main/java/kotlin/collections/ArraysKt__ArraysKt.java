                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m588contentEqualslec5QzE(((ULongArray) t).m284unboximpl(), ((ULongArray) t2).m284unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m584contentEqualsKJPZfPQ(((UIntArray) t).m206unboximpl(), ((UIntArray) t2).m206unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m583contentEqualsFGO6Aew(((UShortArray) t).m388unboximpl(), ((UShortArray) t2).m388unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m586contentEqualskV0jMPg(((UByteArray) t).m128unboximpl(), ((UByteArray) t2).m128unboximpl())) {
                                                        return false;
                                                    }
