...
public class XmlStreamReader extends Reader {
    ...
    private static final ByteOrderMark[] XML_GUESS_BYTES = {new ByteOrderMark("UTF-8", 60, 63, 120, 109), new ByteOrderMark("UTF-16BE", 0, 60, 0, 63), new ByteOrderMark(C.UTF16LE_NAME, 60, 0, 63, 0), new ByteOrderMark("UTF-32BE", 0, 0, 0, 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109), new ByteOrderMark("UTF-32LE", 60, 0, 0, 0, 63, 0, 0, 0, 120, 0, 0, 0, 109, 0, 0, 0), new ByteOrderMark("CP1047", 76, 111, 167, 148)};
    ...
    String calculateRawEncoding(String str, String str2, String str3) throws IOException {
        if (str == null) {
            if (str2 != null && str3 != null) {
                return (!str3.equals(C.UTF16_NAME) || (!str2.equals("UTF-16BE") && !str2.equals(C.UTF16LE_NAME))) ? str3 : str2;
            }
        ...
        } else if (str.equals("UTF-16BE") || str.equals(C.UTF16LE_NAME)) {
            if (str2 != null && !str2.equals(str)) {
                throw new XmlStreamReaderException(MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] encoding mismatch", str, str2, str3), str, str2, str3);
            } else if (str3 == null || str3.equals(C.UTF16_NAME) || str3.equals(str)) {
                return str;
            } else {
                throw new XmlStreamReaderException(MessageFormat.format("Invalid encoding, BOM [{0}] XML guess [{1}] XML prolog [{2}] encoding mismatch", str, str2, str3), str, str2, str3);
            }
    ...
    String calculateHttpEncoding(String str, String str2, String str3, String str4, boolean z) throws IOException {
        ...
        if (!isAppXml && !isTextXml) {
            ...
            return str5 == null ? C.ASCII_NAME : str5;
        } else if (contentTypeEncoding.equals("UTF-16BE") || contentTypeEncoding.equals(C.UTF16LE_NAME)) {
            if (str2 == null) {
        ...
        } else if (contentTypeEncoding.equals(C.UTF16_NAME)) {
            if (str2 != null && str2.startsWith(C.UTF16_NAME)) {
                return str2;
            }
