...
public final class RealConnection extends Http2Connection.Listener implements Connection {
        ...
        try {
            ...
            if (createSocket != null) {
                ...
                try {
                    ...
                    this.handshake = new Handshake(handshake.tlsVersion(), handshake.cipherSuite(), handshake.localCertificates(), new Function0<List<? extends Certificate>>(handshake, address) { // from class: okhttp3.internal.connection.RealConnection$connectTls$1
    ...
    public final RealWebSocket.Streams newWebSocketStreams$okhttp(Exchange exchange) throws SocketException {
        ...
        return new RealWebSocket.Streams(bufferedSource, bufferedSink, true, bufferedSource, bufferedSink) { // from class: okhttp3.internal.connection.RealConnection$newWebSocketStreams$1
