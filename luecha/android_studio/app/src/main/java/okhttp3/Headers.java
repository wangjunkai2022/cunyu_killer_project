...
public final class Headers implements Iterable<Pair<? extends String, ? extends String>>, KMappedMarker {
    ...
    public final int m1535deprecated_size() {
        return size();
    }
    ...
    public static final class Companion {
        ...
        public final Headers m1537deprecated_of(String... strArr) {
            Intrinsics.checkNotNullParameter(strArr, "namesAndValues");
        ...
        /* renamed from: -deprecated_of */
        public final Headers m1536deprecated_of(Map<String, String> map) {
