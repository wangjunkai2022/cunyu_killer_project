...
public final class FormBody extends RequestBody {
    ...
    public final int m1527deprecated_size() {
        return size();
    }
    ...
    public static final class Builder {
        ...
        public final Builder add(String str, String str2) {
            ...
            builder.names.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, builder.charset, 91, null));
            builder.values.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, str2, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", false, false, true, false, builder.charset, 91, null));
            return builder;
        }
        ...
        public final Builder addEncoded(String str, String str2) {
            ...
            Intrinsics.checkNotNullParameter(str2, "value");
            Builder builder = this;
            builder.names.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, str, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, false, builder.charset, 83, null));
            builder.values.add(HttpUrl.Companion.canonicalize$okhttp$default(HttpUrl.Companion, str2, 0, 0, " \"':;<=>@[]^`{}|/\\?#&!$(),~", true, false, true, false, builder.charset, 83, null));
            return builder;
        }
