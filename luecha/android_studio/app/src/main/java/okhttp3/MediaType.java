...
public final class MediaType {
    ...
    public final String m1562deprecated_type() {
        return this.type;
    }
    ...
    public final String m1561deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1563deprecated_get(String str) {
        ...
        public final MediaType m1564deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
    }
