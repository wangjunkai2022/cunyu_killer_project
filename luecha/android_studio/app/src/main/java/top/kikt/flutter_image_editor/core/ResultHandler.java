...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0004\u0018\u0000 \u000e2\u00020\u0001:\u0001\u000eB\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004J\u0006\u0010\u0005\u001a\u00020\u0006J\u0010\u0010\u0007\u001a\u00020\u00062\b\u0010\b\u001a\u0004\u0018\u00010\u0001J&\u0010\t\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u000b2\n\b\u0002\u0010\f\u001a\u0004\u0018\u00010\u000b2\n\b\u0002\u0010\r\u001a\u0004\u0018\u00010\u0001R\u0010\u0010\u0002\u001a\u0004\u0018\u00010\u0003X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Ltop/kikt/flutter_image_editor/core/ResultHandler;", "", "result", "Lio/flutter/plugin/common/MethodChannel$Result;", "(Lio/flutter/plugin/common/MethodChannel$Result;)V", "notImplemented", "", "reply", "any", "replyError", "code", "", "message", "obj", "Companion", "image_editor_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public final class ResultHandler {
    ...
    public final void reply(Object obj) {
        ...
        handler.post(new Runnable(obj) { // from class: top.kikt.flutter_image_editor.core.-$$Lambda$ResultHandler$7NvESr8TTHn7_DVhDDh6sSATqnM
            ...
            public final void run() {
                ResultHandler.m1641reply$lambda0(MethodChannel.Result.this, this.f$1);
            }
        });
    }

    /* renamed from: reply$lambda-0 */
    public static final void m1641reply$lambda0(MethodChannel.Result result, Object obj) {
        if (result != null) {
            result.success(obj);
        }
    }
    ...
    public final void replyError(String str, String str2, Object obj) {
        ...
        handler.post(new Runnable(str, str2, obj) { // from class: top.kikt.flutter_image_editor.core.-$$Lambda$ResultHandler$JzaY0UilUK57VCnPtTAYkNqtlwg
            ...
            @Override // java.lang.Runnable
            public final void run() {
                ResultHandler.m1642replyError$lambda1(MethodChannel.Result.this, this.f$1, this.f$2, this.f$3);
            }
        });
    }

    /* renamed from: replyError$lambda-1 */
    public static final void m1642replyError$lambda1(MethodChannel.Result result, String str, String str2, Object obj) {
        Intrinsics.checkNotNullParameter(str, "$code");
        if (result != null) {
    ...
    public final void notImplemented() {
        handler.post(new Runnable() { // from class: top.kikt.flutter_image_editor.core.-$$Lambda$ResultHandler$so7spSauPuSVVza5qKkMawiskSM
            @Override // java.lang.Runnable
            public final void run() {
                ResultHandler.m1640notImplemented$lambda2(ResultHandler.this);
            }
        });
    }

    /* renamed from: notImplemented$lambda-2 */
    public static final void m1640notImplemented$lambda2(ResultHandler resultHandler) {
