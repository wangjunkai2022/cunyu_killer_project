    ...
    public final void run() {
        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                handleFatalException$kotlinx_coroutines_core(th, Result.m47exceptionOrNullimpl(obj2));
                return;
            }
            ...
            try {
                ...
                taskContext.afterTask();
                obj = Result.m44constructorimpl(Unit.INSTANCE);
            } catch (Throwable th4) {
                Result.Companion companion7 = Result.Companion;
                obj = Result.m44constructorimpl(ResultKt.createFailure(th4));
            }
            handleFatalException$kotlinx_coroutines_core(th3, Result.m47exceptionOrNullimpl(obj));
        }
    }
