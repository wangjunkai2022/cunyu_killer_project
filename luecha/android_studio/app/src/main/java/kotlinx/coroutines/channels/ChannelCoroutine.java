...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    static /* synthetic */ Object m1424receiveOrClosedZYPwvRU$suspendImpl(ChannelCoroutine channelCoroutine, Continuation continuation) {
        return channelCoroutine._channel.mo1423receiveOrClosedZYPwvRU(continuation);
    }
    ...
    public Object mo1423receiveOrClosedZYPwvRU(Continuation<? super ValueOrClosed<? extends E>> continuation) {
        return m1424receiveOrClosedZYPwvRU$suspendImpl(this, continuation);
    }
