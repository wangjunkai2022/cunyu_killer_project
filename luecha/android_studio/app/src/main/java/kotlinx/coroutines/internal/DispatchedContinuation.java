...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public DispatchedContinuation(CoroutineDispatcher coroutineDispatcher, Continuation<? super T> continuation) {
        ...
        this.callerFrame = (CoroutineStackFrame) (!(continuation instanceof CoroutineStackFrame) ? null : continuation);
    ...
    public final void resumeCancellableWith(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m44constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
