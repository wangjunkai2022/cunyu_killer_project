...
public final class UnbiasedSelectBuilderImpl<R> implements SelectBuilder<R> {
    ...
    public void invoke(SelectClause0 selectClause0, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        this.clauses.add(new Function0<Unit>(selectClause0, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$1
    ...
    public <Q> void invoke(SelectClause1<? extends Q> selectClause1, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        this.clauses.add(new Function0<Unit>(selectClause1, function2) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$2
    ...
    public <P, Q> void invoke(SelectClause2<? super P, ? extends Q> selectClause2, P p, Function2<? super Q, ? super Continuation<? super R>, ? extends Object> function2) {
        this.clauses.add(new Function0<Unit>(selectClause2, p, function2) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$invoke$3
            final /* synthetic */ Function2 $block;
    ...
    public void onTimeout(long j, Function1<? super Continuation<? super R>, ? extends Object> function1) {
        this.clauses.add(new Function0<Unit>(j, function1) { // from class: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$onTimeout$1
            final /* synthetic */ Function1 $block;
