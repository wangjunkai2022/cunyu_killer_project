...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        ...
        for (Flow<T> flow : this.flows) {
            Job unused = BuildersKt__Builders_commonKt.launch$default(producerScope, null, null, new ChannelLimitedFlowMerge$collectTo$$inlined$forEach$lambda$1(flow, null, producerScope, sendingCollector), 3, null);
        }
