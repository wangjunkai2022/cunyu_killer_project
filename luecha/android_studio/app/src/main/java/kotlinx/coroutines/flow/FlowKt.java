...
public final class FlowKt {
    ...
    /* renamed from: catch */
    public static final <T> Flow<T> m1455catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt__ErrorsKt.m1462catch(flow, function3);
    }
    ...
    public static final <T> Flow<T> m1456debounce8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1458debounce8GFy2Ro(flow, d);
    }
    ...
    public static final <T> Flow<T> m1457sample8GFy2Ro(Flow<? extends T> flow, double d) {
        return FlowKt__DelayKt.m1459sample8GFy2Ro(flow, d);
    }
