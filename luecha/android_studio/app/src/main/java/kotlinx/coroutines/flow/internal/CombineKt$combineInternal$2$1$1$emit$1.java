...
public final class CombineKt$combineInternal$2$1$1$emit$1 extends ContinuationImpl {
    ...
    public CombineKt$combineInternal$2$1$1$emit$1(CombineKt$combineInternal$2.AnonymousClass1.AnonymousClass1<? super T> r1, Continuation<? super CombineKt$combineInternal$2$1$1$emit$1> continuation) {
        super(continuation);
        this.this$0 = r1;
    }
