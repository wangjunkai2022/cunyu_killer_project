...
public abstract class AbstractFlow<T> implements Flow<T>, CancellableFlow<T> {
    ...
    public final java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L_0x0040:
            ...
            r7.<init>(r6, r2)
            r2 = r7
            kotlinx.coroutines.flow.FlowCollector r2 = (kotlinx.coroutines.flow.FlowCollector) r2     // Catch: all -> 0x0065
            r0.L$0 = r5     // Catch: all -> 0x0065
            r0.L$1 = r6     // Catch: all -> 0x0065
            r0.L$2 = r7     // Catch: all -> 0x0065
            r0.label = r3     // Catch: all -> 0x0065
            java.lang.Object r6 = r5.collectSafely(r2, r0)     // Catch: all -> 0x0065
