...
public final class DelayKt {
    ...
    public static final Object m1419delayp9JZ4hM(double d, Continuation<? super Unit> continuation) {
        Object delay = delay(m1420toDelayMillisLRDsOJo(d), continuation);
    ...
    public static final long m1420toDelayMillisLRDsOJo(double d) {
        if (Duration.compareTo-LRDsOJo(d, Duration.Companion.m1389getZEROUwyO8pc()) > 0) {
