...
final class ChannelsKt__ChannelsKt$trySendBlocking$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (Result.m51isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m1440successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m1438closedJP2dKIU(Result.m47exceptionOrNullimpl(obj2));
        }
        return ChannelResult.m1425boximpl(obj3);
    }
}
