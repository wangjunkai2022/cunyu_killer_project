...
public final class FlowKt__MergeKt$map$$inlined$unsafeTransform$2 implements Flow<R> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        Object collect = this.$this_unsafeTransform$inlined.collect(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$map$$inlined$unsafeTransform$2.2
            ...
            public Object emit$$forInline(Object obj, Continuation continuation2) {
                InlineMarker.mark(4);
                new ContinuationImpl(continuation2) { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$map$.inlined.unsafeTransform.2.2.1
                    Object L$0;
                    Object L$1;
                    Object L$2;
                    Object L$3;
    ...
    public Object collect$$forInline(final FlowCollector flowCollector, Continuation continuation) {
        ...
        InlineMarker.mark(5);
        InlineMarker.mark(0);
        this.$this_unsafeTransform$inlined.collect(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$map$$inlined$unsafeTransform$2.2
            @Override // kotlinx.coroutines.flow.FlowCollector
            /* Code decompiled incorrectly, please refer to instructions dump */
            public java.lang.Object emit(java.lang.Object r11, kotlin.coroutines.Continuation r12) {
                /*
