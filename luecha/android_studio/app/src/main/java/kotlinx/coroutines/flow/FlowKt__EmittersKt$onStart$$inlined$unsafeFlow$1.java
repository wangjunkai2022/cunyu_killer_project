...
public final class FlowKt__EmittersKt$onStart$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector r8, kotlin.coroutines.Continuation r9) {
        ...
        L_0x0063:
            ...
            r5.<init>(r8, r2)
            kotlin.jvm.functions.Function2 r2 = r7.$action$inlined     // Catch: all -> 0x00af
            r0.L$0 = r7     // Catch: all -> 0x00af
            r0.L$1 = r8     // Catch: all -> 0x00af
            r0.L$2 = r9     // Catch: all -> 0x00af
            r0.L$3 = r8     // Catch: all -> 0x00af
            r0.L$4 = r5     // Catch: all -> 0x00af
            r0.label = r4     // Catch: all -> 0x00af
            r4 = 6
            kotlin.jvm.internal.InlineMarker.mark(r4)     // Catch: all -> 0x00af
            java.lang.Object r2 = r2.invoke(r5, r0)     // Catch: all -> 0x00af
            r4 = 7
            kotlin.jvm.internal.InlineMarker.mark(r4)     // Catch: all -> 0x00af
