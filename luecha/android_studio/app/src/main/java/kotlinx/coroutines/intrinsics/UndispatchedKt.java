...
public final class UndispatchedKt {
    public static final <T, R> Object startUndispatchedOrReturn(ScopeCoroutine<? super T> scopeCoroutine, R r, Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        if (function2 != null) {
            obj = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(function2, 2)).invoke(r, scopeCoroutine2);
        ...
        try {
            if (function1 != null) {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m44constructorimpl(invoke));
                    return;
                }
                return;
            }
            ...
            probeCoroutineCreated.resumeWith(Result.m44constructorimpl(ResultKt.createFailure(th)));
        }
    }
