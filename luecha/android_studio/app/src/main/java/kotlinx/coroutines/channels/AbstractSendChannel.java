...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    public final void helpCloseAndResumeWithSendException(Continuation<?> continuation, E e, Closed<?> closed) {
        ...
        continuation.resumeWith(Result.m44constructorimpl(ResultKt.createFailure(undeliveredElementException)));
    }
    ...
    protected Object enqueueSend(Send send) {
        ...
        Send send2 = send;
        AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 abstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1 = new LockFreeLinkedListNode.CondAddOp(send2, this) { // from class: kotlinx.coroutines.channels.AbstractSendChannel$enqueueSend$$inlined$addLastIfPrevAndIf$1
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1468constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1473plusUZ7vuAc(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    final /* synthetic */ Object sendSuspend(E e, Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (offerInternal == AbstractChannelKt.OFFER_SUCCESS) {
                ...
                Result.Companion companion = Result.Companion;
                cancellableContinuationImpl.resumeWith(Result.m44constructorimpl(unit));
                break;
