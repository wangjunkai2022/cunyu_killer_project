...
public final class LintKt {
    ...
    private static final <T> Flow<T> m1463catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        Objects.requireNonNull(sharedFlow, "null cannot be cast to non-null type kotlinx.coroutines.flow.Flow<T>");
        return FlowKt.m1455catch(sharedFlow, function3);
    }
    ...
    private static final <T> Object toList(SharedFlow<? extends T> sharedFlow, Continuation<? super List<? extends T>> continuation) {
        Objects.requireNonNull(sharedFlow, "null cannot be cast to non-null type kotlinx.coroutines.flow.Flow<T>");
        InlineMarker.mark(0);
        Object obj = FlowKt__CollectionKt.toList$default(sharedFlow, null, continuation, 1, null);
        InlineMarker.mark(1);
        return obj;
    }
    ...
    private static final <T> Object toSet(SharedFlow<? extends T> sharedFlow, Continuation<? super Set<? extends T>> continuation) {
        Objects.requireNonNull(sharedFlow, "null cannot be cast to non-null type kotlinx.coroutines.flow.Flow<T>");
        InlineMarker.mark(0);
        Object obj = FlowKt__CollectionKt.toSet$default(sharedFlow, null, continuation, 1, null);
        InlineMarker.mark(1);
        return obj;
    }
