...
public final class OnUndeliveredElementKt {
    ...
    public static final <E> Function1<Throwable, Unit> bindCancellationFun(Function1<? super E, Unit> function1, E e, CoroutineContext coroutineContext) {
        return new Function1<Throwable, Unit>(e, coroutineContext) { // from class: kotlinx.coroutines.internal.OnUndeliveredElementKt$bindCancellationFun$1
            ...
            public final void invoke2(Throwable th) {
                OnUndeliveredElementKt.callUndeliveredElement(Function1.this, this.$element, this.$context);
            }
        };
    }
}
