        ...
        return new Flow<T>() { // from class: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1
            ...
            public Object collect(FlowCollector flowCollector, Continuation continuation) {
                ...
                /*  JADX ERROR: Method code generation error
                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0009: INVOKE  (r3v1 'collect' java.lang.Object) = 
                      (wrap: kotlinx.coroutines.flow.Flow : 0x0000: IGET  (r0v0 kotlinx.coroutines.flow.Flow A[REMOVE]) = (r2v0 'this' kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1 A[IMMUTABLE_TYPE, THIS]) kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1.$this_flattenConcat$inlined kotlinx.coroutines.flow.Flow)
                      (wrap: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1$lambda$1 : 0x0004: CONSTRUCTOR  (r1v0 kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1$lambda$1 A[REMOVE]) = (r3v0 'flowCollector' kotlinx.coroutines.flow.FlowCollector) call: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1$lambda$1.<init>(kotlinx.coroutines.flow.FlowCollector):void type: CONSTRUCTOR)
                      (r4v0 'continuation' kotlin.coroutines.Continuation)
                     type: INTERFACE call: kotlinx.coroutines.flow.Flow.collect(kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object in method: kotlinx.coroutines.flow.FlowKt__MergeKt$flattenConcat$$inlined$unsafeFlow$1.collect(kotlinx.coroutines.flow.FlowCollector, kotlin.coroutines.Continuation):java.lang.Object, file: classes4.dex
